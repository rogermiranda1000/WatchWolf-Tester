...
/**
 * In the generic.TesterTester we're assuming the server request goes well, so let's not assume that on this tests.
 */
...
public class ServersManagerTester extends AbstractTest {
    ...
    public String getConfigFile() {
        return "src/test/java/generic/resources/servers-manager-config.yaml";
    }
