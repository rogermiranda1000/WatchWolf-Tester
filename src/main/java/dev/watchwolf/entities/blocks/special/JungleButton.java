...
public class JungleButton extends Block implements Orientable, Powerable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		JungleButton current = new JungleButton(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public JungleButton(short id) {
		super(id, "JUNGLE_BUTTON", (ins, f) -> {
	...
	public JungleButton(int id) {
		this((short) id);
	}

	private JungleButton(JungleButton old) {
		this(old.id);
