...
public class PrismarineBrickStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		PrismarineBrickStairs current = new PrismarineBrickStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("PrismarineBrickStairs block doesn't allow the section " + section.name());
		PrismarineBrickStairs current = new PrismarineBrickStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public PrismarineBrickStairs(short id) {
		super(id, "PRISMARINE_BRICK_STAIRS", (ins, f) -> {
	...
	public PrismarineBrickStairs(int id) {
		this((short) id);
	}

	private PrismarineBrickStairs(PrismarineBrickStairs old) {
		this(old.id);
