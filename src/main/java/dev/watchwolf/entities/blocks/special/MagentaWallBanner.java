...
public class MagentaWallBanner extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		MagentaWallBanner current = new MagentaWallBanner(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public MagentaWallBanner(short id) {
		super(id, "MAGENTA_WALL_BANNER", (ins, f) -> {
	...
	public MagentaWallBanner(int id) {
		this((short) id);
	}

	private MagentaWallBanner(MagentaWallBanner old) {
		this(old.id);
