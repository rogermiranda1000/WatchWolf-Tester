...
public class LargeFern extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("LargeFern block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("LargeFern block doesn't contain orientation " + o.name());
		LargeFern current = new LargeFern(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public LargeFern(short id) {
		super(id, "LARGE_FERN", (ins, f) -> {
	...
	public LargeFern(int id) {
		this((short) id);
	}

	private LargeFern(LargeFern old) {
		this(old.id);
