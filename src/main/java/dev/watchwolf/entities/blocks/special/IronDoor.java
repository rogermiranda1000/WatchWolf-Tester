...
public class IronDoor extends Block implements Orientable, Hinged, Openable, Powerable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		IronDoor current = new IronDoor(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public IronDoor(short id) {
		super(id, "IRON_DOOR", (ins, f) -> {
	...
	public IronDoor(int id) {
		this((short) id);
	}

	private IronDoor(IronDoor old) {
		this(old.id);
