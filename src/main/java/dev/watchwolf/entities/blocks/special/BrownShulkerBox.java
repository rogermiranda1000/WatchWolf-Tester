...
public class BrownShulkerBox extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		BrownShulkerBox current = new BrownShulkerBox(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public BrownShulkerBox(short id) {
		super(id, "BROWN_SHULKER_BOX", (ins, f) -> {
	...
	public BrownShulkerBox(int id) {
		this((short) id);
	}

	private BrownShulkerBox(BrownShulkerBox old) {
		this(old.id);
