...
public class Smoker extends Block implements Orientable, Ignitable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		Smoker current = new Smoker(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public Smoker(short id) {
		super(id, "SMOKER", (ins, f) -> {
