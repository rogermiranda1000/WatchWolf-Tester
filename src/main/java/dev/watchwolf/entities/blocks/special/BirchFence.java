...
public class BirchFence extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("BirchFence block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("BirchFence block doesn't contain orientation " + o.name());
		BirchFence current = new BirchFence(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public BirchFence(short id) {
		super(id, "BIRCH_FENCE", (ins, f) -> {
	...
	private BirchFence(BirchFence old) {
		this(old.id);
