...
public class EndRod extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		EndRod current = new EndRod(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public EndRod(short id) {
		super(id, "END_ROD", (ins, f) -> {
	...
	public EndRod(int id) {
		this((short) id);
	}

	private EndRod(EndRod old) {
		this(old.id);
