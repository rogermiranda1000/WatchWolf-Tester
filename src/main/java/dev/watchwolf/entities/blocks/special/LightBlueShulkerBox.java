...
public class LightBlueShulkerBox extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		LightBlueShulkerBox current = new LightBlueShulkerBox(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public LightBlueShulkerBox(short id) {
		super(id, "LIGHT_BLUE_SHULKER_BOX", (ins, f) -> {
	...
	public LightBlueShulkerBox(int id) {
		this((short) id);
	}

	private LightBlueShulkerBox(LightBlueShulkerBox old) {
		this(old.id);
