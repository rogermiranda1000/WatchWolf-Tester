...
public class BlackstoneStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		BlackstoneStairs current = new BlackstoneStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("BlackstoneStairs block doesn't allow the section " + section.name());
		BlackstoneStairs current = new BlackstoneStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public BlackstoneStairs(short id) {
		super(id, "BLACKSTONE_STAIRS", (ins, f) -> {
	...
	public BlackstoneStairs(int id) {
		this((short) id);
	}

	private BlackstoneStairs(BlackstoneStairs old) {
		this(old.id);
