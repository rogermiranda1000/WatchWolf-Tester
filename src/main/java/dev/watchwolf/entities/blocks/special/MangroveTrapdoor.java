...
public class MangroveTrapdoor extends Block implements Orientable, Openable, Powerable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		MangroveTrapdoor current = new MangroveTrapdoor(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public MangroveTrapdoor(short id) {
		super(id, "MANGROVE_TRAPDOOR", (ins, f) -> {
	...
	public MangroveTrapdoor(int id) {
		this((short) id);
	}

	private MangroveTrapdoor(MangroveTrapdoor old) {
		this(old.id);
