...
public class BlueGlazedTerracotta extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		BlueGlazedTerracotta current = new BlueGlazedTerracotta(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public BlueGlazedTerracotta(short id) {
		super(id, "BLUE_GLAZED_TERRACOTTA", (ins, f) -> {
	...
	public BlueGlazedTerracotta(int id) {
		this((short) id);
	}

	private BlueGlazedTerracotta(BlueGlazedTerracotta old) {
		this(old.id);
