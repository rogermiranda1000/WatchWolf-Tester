...
public class WhiteStainedGlassPane extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("WhiteStainedGlassPane block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("WhiteStainedGlassPane block doesn't contain orientation " + o.name());
		WhiteStainedGlassPane current = new WhiteStainedGlassPane(this);
	...
	public WhiteStainedGlassPane(short id) {
		super(id, "WHITE_STAINED_GLASS_PANE", (ins, f) -> {
	...
	private WhiteStainedGlassPane(WhiteStainedGlassPane old) {
		this(old.id);
