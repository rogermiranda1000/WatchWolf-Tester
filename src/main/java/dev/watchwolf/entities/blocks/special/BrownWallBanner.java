...
public class BrownWallBanner extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		BrownWallBanner current = new BrownWallBanner(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public BrownWallBanner(short id) {
		super(id, "BROWN_WALL_BANNER", (ins, f) -> {
	...
	public BrownWallBanner(int id) {
		this((short) id);
	}

	private BrownWallBanner(BrownWallBanner old) {
		this(old.id);
