...
public class AmethystCluster extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		AmethystCluster current = new AmethystCluster(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public AmethystCluster(short id) {
		super(id, "AMETHYST_CLUSTER", (ins, f) -> {
	...
	public AmethystCluster(int id) {
		this((short) id);
	}

	private AmethystCluster(AmethystCluster old) {
		this(old.id);
