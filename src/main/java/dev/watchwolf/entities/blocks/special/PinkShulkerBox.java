...
public class PinkShulkerBox extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		PinkShulkerBox current = new PinkShulkerBox(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public PinkShulkerBox(short id) {
		super(id, "PINK_SHULKER_BOX", (ins, f) -> {
	...
	public PinkShulkerBox(int id) {
		this((short) id);
	}

	private PinkShulkerBox(PinkShulkerBox old) {
		this(old.id);
