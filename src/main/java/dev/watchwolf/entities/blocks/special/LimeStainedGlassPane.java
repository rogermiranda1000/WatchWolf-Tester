...
public class LimeStainedGlassPane extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("LimeStainedGlassPane block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("LimeStainedGlassPane block doesn't contain orientation " + o.name());
		LimeStainedGlassPane current = new LimeStainedGlassPane(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public LimeStainedGlassPane(short id) {
		super(id, "LIME_STAINED_GLASS_PANE", (ins, f) -> {
	...
	public LimeStainedGlassPane(int id) {
		this((short) id);
	}

	private LimeStainedGlassPane(LimeStainedGlassPane old) {
		this(old.id);
