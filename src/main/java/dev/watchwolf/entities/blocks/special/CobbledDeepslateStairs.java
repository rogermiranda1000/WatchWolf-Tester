...
public class CobbledDeepslateStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		CobbledDeepslateStairs current = new CobbledDeepslateStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("CobbledDeepslateStairs block doesn't allow the section " + section.name());
		CobbledDeepslateStairs current = new CobbledDeepslateStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public CobbledDeepslateStairs(short id) {
		super(id, "COBBLED_DEEPSLATE_STAIRS", (ins, f) -> {
	...
	public CobbledDeepslateStairs(int id) {
		this((short) id);
	}

	private CobbledDeepslateStairs(CobbledDeepslateStairs old) {
		this(old.id);
