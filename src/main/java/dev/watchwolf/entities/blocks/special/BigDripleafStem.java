...
public class BigDripleafStem extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		BigDripleafStem current = new BigDripleafStem(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public BigDripleafStem(short id) {
		super(id, "BIG_DRIPLEAF_STEM", (ins, f) -> {
	...
	public BigDripleafStem(int id) {
		this((short) id);
	}

	private BigDripleafStem(BigDripleafStem old) {
		this(old.id);
