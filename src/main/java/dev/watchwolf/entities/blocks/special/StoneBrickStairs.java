...
public class StoneBrickStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		StoneBrickStairs current = new StoneBrickStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("StoneBrickStairs block doesn't allow the section " + section.name());
		StoneBrickStairs current = new StoneBrickStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public StoneBrickStairs(short id) {
		super(id, "STONE_BRICK_STAIRS", (ins, f) -> {
	...
	public StoneBrickStairs(int id) {
		this((short) id);
	}

	private StoneBrickStairs(StoneBrickStairs old) {
		this(old.id);
