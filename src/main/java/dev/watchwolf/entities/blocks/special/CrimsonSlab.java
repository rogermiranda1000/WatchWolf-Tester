...
public class CrimsonSlab extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("CrimsonSlab block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("CrimsonSlab block doesn't contain orientation " + o.name());
		CrimsonSlab current = new CrimsonSlab(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public CrimsonSlab(short id) {
		super(id, "CRIMSON_SLAB", (ins, f) -> {
	...
	public CrimsonSlab(int id) {
		this((short) id);
	}

	private CrimsonSlab(CrimsonSlab old) {
		this(old.id);
