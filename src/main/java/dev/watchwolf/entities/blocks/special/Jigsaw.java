...
public class Jigsaw extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		Jigsaw current = new Jigsaw(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public Jigsaw(short id) {
		super(id, "JIGSAW", (ins, f) -> {
	...
	public Jigsaw(int id) {
		this((short) id);
	}

	private Jigsaw(Jigsaw old) {
		this(old.id);
