...
public class WaxedOxidizedCutCopperStairs extends Block implements Orientable, Sectionable {
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("WaxedOxidizedCutCopperStairs block doesn't allow the section " + section.name());
		WaxedOxidizedCutCopperStairs current = new WaxedOxidizedCutCopperStairs(this);
	...
	public WaxedOxidizedCutCopperStairs(short id) {
		super(id, "WAXED_OXIDIZED_CUT_COPPER_STAIRS", (ins, f) -> {
