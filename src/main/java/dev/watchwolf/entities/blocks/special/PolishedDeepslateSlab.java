...
public class PolishedDeepslateSlab extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("PolishedDeepslateSlab block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("PolishedDeepslateSlab block doesn't contain orientation " + o.name());
		PolishedDeepslateSlab current = new PolishedDeepslateSlab(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public PolishedDeepslateSlab(short id) {
		super(id, "POLISHED_DEEPSLATE_SLAB", (ins, f) -> {
	...
	public PolishedDeepslateSlab(int id) {
		this((short) id);
	}

	private PolishedDeepslateSlab(PolishedDeepslateSlab old) {
		this(old.id);
