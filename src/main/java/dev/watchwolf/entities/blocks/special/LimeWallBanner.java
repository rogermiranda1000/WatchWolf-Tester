...
public class LimeWallBanner extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		LimeWallBanner current = new LimeWallBanner(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public LimeWallBanner(short id) {
		super(id, "LIME_WALL_BANNER", (ins, f) -> {
	...
	public LimeWallBanner(int id) {
		this((short) id);
	}

	private LimeWallBanner(LimeWallBanner old) {
		this(old.id);
