...
public class Lilac extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("Lilac block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("Lilac block doesn't contain orientation " + o.name());
		Lilac current = new Lilac(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public Lilac(short id) {
		super(id, "LILAC", (ins, f) -> {
