...
public class AndesiteWall extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("AndesiteWall block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("AndesiteWall block doesn't contain orientation " + o.name());
		AndesiteWall current = new AndesiteWall(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public AndesiteWall(short id) {
		super(id, "ANDESITE_WALL", (ins, f) -> {
	...
	public AndesiteWall(int id) {
		this((short) id);
	}

	private AndesiteWall(AndesiteWall old) {
		this(old.id);
