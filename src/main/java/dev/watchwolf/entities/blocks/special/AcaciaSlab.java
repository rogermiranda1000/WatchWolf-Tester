...
public class AcaciaSlab extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("AcaciaSlab block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("AcaciaSlab block doesn't contain orientation " + o.name());
		AcaciaSlab current = new AcaciaSlab(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public AcaciaSlab(short id) {
		super(id, "ACACIA_SLAB", (ins, f) -> {
	...
	public AcaciaSlab(int id) {
		this((short) id);
	}

	private AcaciaSlab(AcaciaSlab old) {
		this(old.id);
