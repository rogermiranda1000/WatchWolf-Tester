...
public class TubeCoralWallFan extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		TubeCoralWallFan current = new TubeCoralWallFan(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public TubeCoralWallFan(short id) {
		super(id, "TUBE_CORAL_WALL_FAN", (ins, f) -> {
	...
	public TubeCoralWallFan(int id) {
		this((short) id);
	}

	private TubeCoralWallFan(TubeCoralWallFan old) {
		this(old.id);
