...
public class NetherBrickStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		NetherBrickStairs current = new NetherBrickStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("NetherBrickStairs block doesn't allow the section " + section.name());
		NetherBrickStairs current = new NetherBrickStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public NetherBrickStairs(short id) {
		super(id, "NETHER_BRICK_STAIRS", (ins, f) -> {
	...
	public NetherBrickStairs(int id) {
		this((short) id);
	}

	private NetherBrickStairs(NetherBrickStairs old) {
		this(old.id);
