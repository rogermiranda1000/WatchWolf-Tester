...
public class LightGrayShulkerBox extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		LightGrayShulkerBox current = new LightGrayShulkerBox(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public LightGrayShulkerBox(short id) {
		super(id, "LIGHT_GRAY_SHULKER_BOX", (ins, f) -> {
	...
	public LightGrayShulkerBox(int id) {
		this((short) id);
	}

	private LightGrayShulkerBox(LightGrayShulkerBox old) {
		this(old.id);
