...
public class MossyCobblestoneStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		MossyCobblestoneStairs current = new MossyCobblestoneStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("MossyCobblestoneStairs block doesn't allow the section " + section.name());
		MossyCobblestoneStairs current = new MossyCobblestoneStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public MossyCobblestoneStairs(short id) {
		super(id, "MOSSY_COBBLESTONE_STAIRS", (ins, f) -> {
	...
	public MossyCobblestoneStairs(int id) {
		this((short) id);
	}

	private MossyCobblestoneStairs(MossyCobblestoneStairs old) {
		this(old.id);
