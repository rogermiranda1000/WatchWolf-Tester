...
public class PrismarineBrickSlab extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("PrismarineBrickSlab block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("PrismarineBrickSlab block doesn't contain orientation " + o.name());
		PrismarineBrickSlab current = new PrismarineBrickSlab(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public PrismarineBrickSlab(short id) {
		super(id, "PRISMARINE_BRICK_SLAB", (ins, f) -> {
	...
	public PrismarineBrickSlab(int id) {
		this((short) id);
	}

	private PrismarineBrickSlab(PrismarineBrickSlab old) {
		this(old.id);
