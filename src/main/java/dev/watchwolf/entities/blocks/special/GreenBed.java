...
public class GreenBed extends Block implements Orientable, Sectionable {
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("GreenBed block doesn't allow the section " + section.name());
		GreenBed current = new GreenBed(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public GreenBed(short id) {
		super(id, "GREEN_BED", (ins, f) -> {
