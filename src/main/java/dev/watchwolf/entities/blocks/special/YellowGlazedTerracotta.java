...
public class YellowGlazedTerracotta extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		YellowGlazedTerracotta current = new YellowGlazedTerracotta(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public YellowGlazedTerracotta(short id) {
		super(id, "YELLOW_GLAZED_TERRACOTTA", (ins, f) -> {
	...
	public YellowGlazedTerracotta(int id) {
		this((short) id);
	}

	private YellowGlazedTerracotta(YellowGlazedTerracotta old) {
		this(old.id);
