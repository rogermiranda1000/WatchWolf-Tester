...
public class ZombieWallHead extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		ZombieWallHead current = new ZombieWallHead(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public ZombieWallHead(short id) {
		super(id, "ZOMBIE_WALL_HEAD", (ins, f) -> {
	...
	public ZombieWallHead(int id) {
		this((short) id);
	}

	private ZombieWallHead(ZombieWallHead old) {
		this(old.id);
