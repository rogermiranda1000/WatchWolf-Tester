...
public class SmoothRedSandstoneStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		SmoothRedSandstoneStairs current = new SmoothRedSandstoneStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("SmoothRedSandstoneStairs block doesn't allow the section " + section.name());
		SmoothRedSandstoneStairs current = new SmoothRedSandstoneStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public SmoothRedSandstoneStairs(short id) {
		super(id, "SMOOTH_RED_SANDSTONE_STAIRS", (ins, f) -> {
	...
	public SmoothRedSandstoneStairs(int id) {
		this((short) id);
	}

	private SmoothRedSandstoneStairs(SmoothRedSandstoneStairs old) {
		this(old.id);
