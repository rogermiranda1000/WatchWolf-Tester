...
public class OrangeWallBanner extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		OrangeWallBanner current = new OrangeWallBanner(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public OrangeWallBanner(short id) {
		super(id, "ORANGE_WALL_BANNER", (ins, f) -> {
	...
	public OrangeWallBanner(int id) {
		this((short) id);
	}

	private OrangeWallBanner(OrangeWallBanner old) {
		this(old.id);
