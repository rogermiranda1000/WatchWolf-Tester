...
public class MangroveDoor extends Block implements Orientable, Hinged, Openable, Powerable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		MangroveDoor current = new MangroveDoor(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public MangroveDoor(short id) {
		super(id, "MANGROVE_DOOR", (ins, f) -> {
	...
	public MangroveDoor(int id) {
		this((short) id);
	}

	private MangroveDoor(MangroveDoor old) {
		this(old.id);
