...
public class DarkOakWallSign extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		DarkOakWallSign current = new DarkOakWallSign(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public DarkOakWallSign(short id) {
		super(id, "DARK_OAK_WALL_SIGN", (ins, f) -> {
	...
	public DarkOakWallSign(int id) {
		this((short) id);
	}

	private DarkOakWallSign(DarkOakWallSign old) {
		this(old.id);
