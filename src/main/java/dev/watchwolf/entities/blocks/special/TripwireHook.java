...
public class TripwireHook extends Block implements Orientable, Powerable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		TripwireHook current = new TripwireHook(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public TripwireHook(short id) {
		super(id, "TRIPWIRE_HOOK", (ins, f) -> {
	...
	public TripwireHook(int id) {
		this((short) id);
	}

	private TripwireHook(TripwireHook old) {
		this(old.id);
