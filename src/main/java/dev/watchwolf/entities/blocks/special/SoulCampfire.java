...
public class SoulCampfire extends Block implements Orientable, Ignitable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		SoulCampfire current = new SoulCampfire(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public SoulCampfire(short id) {
		super(id, "SOUL_CAMPFIRE", (ins, f) -> {
	...
	public SoulCampfire(int id) {
		this((short) id);
	}

	private SoulCampfire(SoulCampfire old) {
		this(old.id);
