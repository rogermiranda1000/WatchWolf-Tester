...
public class SpruceFenceGate extends Block implements Orientable, Openable, Powerable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		SpruceFenceGate current = new SpruceFenceGate(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public SpruceFenceGate(short id) {
		super(id, "SPRUCE_FENCE_GATE", (ins, f) -> {
	...
	public SpruceFenceGate(int id) {
		this((short) id);
	}

	private SpruceFenceGate(SpruceFenceGate old) {
		this(old.id);
