...
public class CyanShulkerBox extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		CyanShulkerBox current = new CyanShulkerBox(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public CyanShulkerBox(short id) {
		super(id, "CYAN_SHULKER_BOX", (ins, f) -> {
	...
	public CyanShulkerBox(int id) {
		this((short) id);
	}

	private CyanShulkerBox(CyanShulkerBox old) {
		this(old.id);
