...
public class ChorusPlant extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		ChorusPlant current = new ChorusPlant(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public ChorusPlant(short id) {
		super(id, "CHORUS_PLANT", (ins, f) -> {
	...
	public ChorusPlant(int id) {
		this((short) id);
	}

	private ChorusPlant(ChorusPlant old) {
		this(old.id);
