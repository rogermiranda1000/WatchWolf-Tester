...
public class RedstoneWire extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("RedstoneWire block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("RedstoneWire block doesn't contain orientation " + o.name());
		RedstoneWire current = new RedstoneWire(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public RedstoneWire(short id) {
		super(id, "REDSTONE_WIRE", (ins, f) -> {
	...
	public RedstoneWire(int id) {
		this((short) id);
	}

	private RedstoneWire(RedstoneWire old) {
		this(old.id);
