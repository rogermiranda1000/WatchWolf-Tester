...
public class PolishedBlackstoneButton extends Block implements Orientable, Powerable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		PolishedBlackstoneButton current = new PolishedBlackstoneButton(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public PolishedBlackstoneButton(short id) {
		super(id, "POLISHED_BLACKSTONE_BUTTON", (ins, f) -> {
	...
	public PolishedBlackstoneButton(int id) {
		this((short) id);
	}

	private PolishedBlackstoneButton(PolishedBlackstoneButton old) {
		this(old.id);
