...
public class Dispenser extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		Dispenser current = new Dispenser(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public Dispenser(short id) {
		super(id, "DISPENSER", (ins, f) -> {
	...
	private Dispenser(Dispenser old) {
		this(old.id);
