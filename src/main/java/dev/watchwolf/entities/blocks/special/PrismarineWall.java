...
public class PrismarineWall extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("PrismarineWall block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("PrismarineWall block doesn't contain orientation " + o.name());
		PrismarineWall current = new PrismarineWall(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public PrismarineWall(short id) {
		super(id, "PRISMARINE_WALL", (ins, f) -> {
	...
	public PrismarineWall(int id) {
		this((short) id);
	}

	private PrismarineWall(PrismarineWall old) {
		this(old.id);
