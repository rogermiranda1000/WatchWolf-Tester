...
public class CutCopperSlab extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("CutCopperSlab block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("CutCopperSlab block doesn't contain orientation " + o.name());
		CutCopperSlab current = new CutCopperSlab(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public CutCopperSlab(short id) {
		super(id, "CUT_COPPER_SLAB", (ins, f) -> {
	...
	public CutCopperSlab(int id) {
		this((short) id);
	}

	private CutCopperSlab(CutCopperSlab old) {
		this(old.id);
