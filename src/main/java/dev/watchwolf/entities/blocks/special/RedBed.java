...
public class RedBed extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		RedBed current = new RedBed(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("RedBed block doesn't allow the section " + section.name());
		RedBed current = new RedBed(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public RedBed(short id) {
		super(id, "RED_BED", (ins, f) -> {
	...
	public RedBed(int id) {
		this((short) id);
	}

	private RedBed(RedBed old) {
		this(old.id);
