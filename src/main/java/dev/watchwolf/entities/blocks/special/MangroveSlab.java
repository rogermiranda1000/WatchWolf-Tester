...
public class MangroveSlab extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("MangroveSlab block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("MangroveSlab block doesn't contain orientation " + o.name());
		MangroveSlab current = new MangroveSlab(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public MangroveSlab(short id) {
		super(id, "MANGROVE_SLAB", (ins, f) -> {
	...
	public MangroveSlab(int id) {
		this((short) id);
	}

	private MangroveSlab(MangroveSlab old) {
		this(old.id);
