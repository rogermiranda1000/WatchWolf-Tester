...
public class Lectern extends Block implements Orientable, Powerable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		Lectern current = new Lectern(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public Lectern(short id) {
		super(id, "LECTERN", (ins, f) -> {
	...
	public Lectern(int id) {
		this((short) id);
	}

	private Lectern(Lectern old) {
		this(old.id);
