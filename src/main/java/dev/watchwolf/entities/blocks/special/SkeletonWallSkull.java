...
public class SkeletonWallSkull extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		SkeletonWallSkull current = new SkeletonWallSkull(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public SkeletonWallSkull(short id) {
		super(id, "SKELETON_WALL_SKULL", (ins, f) -> {
	...
	public SkeletonWallSkull(int id) {
		this((short) id);
	}

	private SkeletonWallSkull(SkeletonWallSkull old) {
		this(old.id);
