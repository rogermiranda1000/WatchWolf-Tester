...
public class LightGrayBed extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		LightGrayBed current = new LightGrayBed(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("LightGrayBed block doesn't allow the section " + section.name());
		LightGrayBed current = new LightGrayBed(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public LightGrayBed(short id) {
		super(id, "LIGHT_GRAY_BED", (ins, f) -> {
	...
	public LightGrayBed(int id) {
		this((short) id);
	}

	private LightGrayBed(LightGrayBed old) {
		this(old.id);
