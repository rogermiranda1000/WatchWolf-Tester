...
public class PurpurStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		PurpurStairs current = new PurpurStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("PurpurStairs block doesn't allow the section " + section.name());
		PurpurStairs current = new PurpurStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public PurpurStairs(short id) {
		super(id, "PURPUR_STAIRS", (ins, f) -> {
	...
	public PurpurStairs(int id) {
		this((short) id);
	}

	private PurpurStairs(PurpurStairs old) {
		this(old.id);
