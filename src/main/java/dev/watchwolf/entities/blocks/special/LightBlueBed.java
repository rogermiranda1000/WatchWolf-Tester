...
public class LightBlueBed extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		LightBlueBed current = new LightBlueBed(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("LightBlueBed block doesn't allow the section " + section.name());
		LightBlueBed current = new LightBlueBed(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public LightBlueBed(short id) {
		super(id, "LIGHT_BLUE_BED", (ins, f) -> {
		...
		this.section = Sectionable.Section.HEAD;
	}

	public LightBlueBed(int id) {
		this((short) id);
	}

	private LightBlueBed(LightBlueBed old) {
		this(old.id);
