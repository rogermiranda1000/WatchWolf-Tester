...
public class CrimsonWallSign extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		CrimsonWallSign current = new CrimsonWallSign(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public CrimsonWallSign(short id) {
		super(id, "CRIMSON_WALL_SIGN", (ins, f) -> {
	...
	public CrimsonWallSign(int id) {
		this((short) id);
	}

	private CrimsonWallSign(CrimsonWallSign old) {
		this(old.id);
