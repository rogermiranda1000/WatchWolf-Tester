...
public class CobblestoneSlab extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("CobblestoneSlab block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("CobblestoneSlab block doesn't contain orientation " + o.name());
		CobblestoneSlab current = new CobblestoneSlab(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public CobblestoneSlab(short id) {
		super(id, "COBBLESTONE_SLAB", (ins, f) -> {
	...
	public CobblestoneSlab(int id) {
		this((short) id);
	}

	private CobblestoneSlab(CobblestoneSlab old) {
		this(old.id);
