...
public class EnderChest extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		EnderChest current = new EnderChest(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public EnderChest(short id) {
		super(id, "ENDER_CHEST", (ins, f) -> {
	...
	public EnderChest(int id) {
		this((short) id);
	}

	private EnderChest(EnderChest old) {
		this(old.id);
