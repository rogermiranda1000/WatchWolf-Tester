...
public class OakDoor extends Block implements Orientable, Hinged, Openable, Powerable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		OakDoor current = new OakDoor(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public OakDoor(short id) {
		super(id, "OAK_DOOR", (ins, f) -> {
	...
	public OakDoor(int id) {
		this((short) id);
	}

	private OakDoor(OakDoor old) {
		this(old.id);
