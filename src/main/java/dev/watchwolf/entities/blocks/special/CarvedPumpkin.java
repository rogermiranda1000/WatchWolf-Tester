...
public class CarvedPumpkin extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		CarvedPumpkin current = new CarvedPumpkin(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public CarvedPumpkin(short id) {
		super(id, "CARVED_PUMPKIN", (ins, f) -> {
	...
	public CarvedPumpkin(int id) {
		this((short) id);
	}

	private CarvedPumpkin(CarvedPumpkin old) {
		this(old.id);
