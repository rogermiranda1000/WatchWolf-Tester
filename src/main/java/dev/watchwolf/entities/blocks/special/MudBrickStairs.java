...
public class MudBrickStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		MudBrickStairs current = new MudBrickStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("MudBrickStairs block doesn't allow the section " + section.name());
		MudBrickStairs current = new MudBrickStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public MudBrickStairs(short id) {
		super(id, "MUD_BRICK_STAIRS", (ins, f) -> {
	...
	public MudBrickStairs(int id) {
		this((short) id);
	}

	private MudBrickStairs(MudBrickStairs old) {
		this(old.id);
