...
public class BlueBed extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		BlueBed current = new BlueBed(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("BlueBed block doesn't allow the section " + section.name());
		BlueBed current = new BlueBed(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public BlueBed(short id) {
		super(id, "BLUE_BED", (ins, f) -> {
	...
	public BlueBed(int id) {
		this((short) id);
	}

	private BlueBed(BlueBed old) {
		this(old.id);
