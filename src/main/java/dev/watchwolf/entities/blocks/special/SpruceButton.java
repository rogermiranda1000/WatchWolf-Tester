...
public class SpruceButton extends Block implements Orientable, Powerable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		SpruceButton current = new SpruceButton(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public SpruceButton(short id) {
		super(id, "SPRUCE_BUTTON", (ins, f) -> {
	...
	public SpruceButton(int id) {
		this((short) id);
	}

	private SpruceButton(SpruceButton old) {
		this(old.id);
