...
public class BirchFenceGate extends Block implements Orientable, Openable, Powerable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		BirchFenceGate current = new BirchFenceGate(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public BirchFenceGate(short id) {
		super(id, "BIRCH_FENCE_GATE", (ins, f) -> {
	...
	public BirchFenceGate(int id) {
		this((short) id);
	}

	private BirchFenceGate(BirchFenceGate old) {
		this(old.id);
