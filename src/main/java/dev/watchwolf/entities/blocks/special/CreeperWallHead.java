...
public class CreeperWallHead extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		CreeperWallHead current = new CreeperWallHead(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public CreeperWallHead(short id) {
		super(id, "CREEPER_WALL_HEAD", (ins, f) -> {
	...
	public CreeperWallHead(int id) {
		this((short) id);
	}

	private CreeperWallHead(CreeperWallHead old) {
		this(old.id);
