...
public class OakFence extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("OakFence block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("OakFence block doesn't contain orientation " + o.name());
		OakFence current = new OakFence(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public OakFence(short id) {
		super(id, "OAK_FENCE", (ins, f) -> {
	...
	public OakFence(int id) {
		this((short) id);
	}

	private OakFence(OakFence old) {
		this(old.id);
