...
public class GrayStainedGlassPane extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("GrayStainedGlassPane block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("GrayStainedGlassPane block doesn't contain orientation " + o.name());
		GrayStainedGlassPane current = new GrayStainedGlassPane(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public GrayStainedGlassPane(short id) {
		super(id, "GRAY_STAINED_GLASS_PANE", (ins, f) -> {
	...
	public GrayStainedGlassPane(int id) {
		this((short) id);
	}

	private GrayStainedGlassPane(GrayStainedGlassPane old) {
		this(old.id);
