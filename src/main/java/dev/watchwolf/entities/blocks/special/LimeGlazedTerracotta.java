...
public class LimeGlazedTerracotta extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		LimeGlazedTerracotta current = new LimeGlazedTerracotta(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public LimeGlazedTerracotta(short id) {
		super(id, "LIME_GLAZED_TERRACOTTA", (ins, f) -> {
	...
	public LimeGlazedTerracotta(int id) {
		this((short) id);
	}

	private LimeGlazedTerracotta(LimeGlazedTerracotta old) {
		this(old.id);
