...
public class Sunflower extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("Sunflower block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("Sunflower block doesn't contain orientation " + o.name());
		Sunflower current = new Sunflower(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public Sunflower(short id) {
		super(id, "SUNFLOWER", (ins, f) -> {
	...
	private Sunflower(Sunflower old) {
		this(old.id);
