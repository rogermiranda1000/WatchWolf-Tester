...
public class WhiteShulkerBox extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		WhiteShulkerBox current = new WhiteShulkerBox(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public WhiteShulkerBox(short id) {
		super(id, "WHITE_SHULKER_BOX", (ins, f) -> {
	...
	public WhiteShulkerBox(int id) {
		this((short) id);
	}

	private WhiteShulkerBox(WhiteShulkerBox old) {
		this(old.id);
