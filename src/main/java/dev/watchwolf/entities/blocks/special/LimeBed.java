...
public class LimeBed extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		LimeBed current = new LimeBed(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("LimeBed block doesn't allow the section " + section.name());
		LimeBed current = new LimeBed(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public LimeBed(short id) {
		super(id, "LIME_BED", (ins, f) -> {
	...
	public LimeBed(int id) {
		this((short) id);
	}

	private LimeBed(LimeBed old) {
		this(old.id);
