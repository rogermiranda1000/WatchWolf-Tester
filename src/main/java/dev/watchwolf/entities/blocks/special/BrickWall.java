...
public class BrickWall extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("BrickWall block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("BrickWall block doesn't contain orientation " + o.name());
		BrickWall current = new BrickWall(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public BrickWall(short id) {
		super(id, "BRICK_WALL", (ins, f) -> {
	...
	private BrickWall(BrickWall old) {
		this(old.id);
