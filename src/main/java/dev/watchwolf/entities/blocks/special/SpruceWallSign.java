...
public class SpruceWallSign extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		SpruceWallSign current = new SpruceWallSign(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public SpruceWallSign(short id) {
		super(id, "SPRUCE_WALL_SIGN", (ins, f) -> {
	...
	public SpruceWallSign(int id) {
		this((short) id);
	}

	private SpruceWallSign(SpruceWallSign old) {
		this(old.id);
