...
public class AcaciaStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		AcaciaStairs current = new AcaciaStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("AcaciaStairs block doesn't allow the section " + section.name());
		AcaciaStairs current = new AcaciaStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public AcaciaStairs(short id) {
		super(id, "ACACIA_STAIRS", (ins, f) -> {
	...
	public AcaciaStairs(int id) {
		this((short) id);
	}

	private AcaciaStairs(AcaciaStairs old) {
		this(old.id);
