...
public class OakFenceGate extends Block implements Orientable, Openable, Powerable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		OakFenceGate current = new OakFenceGate(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public OakFenceGate(short id) {
		super(id, "OAK_FENCE_GATE", (ins, f) -> {
	...
	public OakFenceGate(int id) {
		this((short) id);
	}

	private OakFenceGate(OakFenceGate old) {
		this(old.id);
