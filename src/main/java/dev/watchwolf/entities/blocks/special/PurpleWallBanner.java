...
public class PurpleWallBanner extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		PurpleWallBanner current = new PurpleWallBanner(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public PurpleWallBanner(short id) {
		super(id, "PURPLE_WALL_BANNER", (ins, f) -> {
	...
	public PurpleWallBanner(int id) {
		this((short) id);
	}

	private PurpleWallBanner(PurpleWallBanner old) {
		this(old.id);
