...
public class WaxedExposedCutCopperStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		WaxedExposedCutCopperStairs current = new WaxedExposedCutCopperStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("WaxedExposedCutCopperStairs block doesn't allow the section " + section.name());
		WaxedExposedCutCopperStairs current = new WaxedExposedCutCopperStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public WaxedExposedCutCopperStairs(short id) {
		super(id, "WAXED_EXPOSED_CUT_COPPER_STAIRS", (ins, f) -> {
	...
	public WaxedExposedCutCopperStairs(int id) {
		this((short) id);
	}

	private WaxedExposedCutCopperStairs(WaxedExposedCutCopperStairs old) {
		this(old.id);
