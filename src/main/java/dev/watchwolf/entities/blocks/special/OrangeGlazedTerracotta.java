...
public class OrangeGlazedTerracotta extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		OrangeGlazedTerracotta current = new OrangeGlazedTerracotta(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public OrangeGlazedTerracotta(short id) {
		super(id, "ORANGE_GLAZED_TERRACOTTA", (ins, f) -> {
	...
	public OrangeGlazedTerracotta(int id) {
		this((short) id);
	}

	private OrangeGlazedTerracotta(OrangeGlazedTerracotta old) {
		this(old.id);
