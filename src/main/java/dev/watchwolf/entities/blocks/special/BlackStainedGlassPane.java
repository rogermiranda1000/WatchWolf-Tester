...
public class BlackStainedGlassPane extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("BlackStainedGlassPane block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("BlackStainedGlassPane block doesn't contain orientation " + o.name());
		BlackStainedGlassPane current = new BlackStainedGlassPane(this);
	...
	public BlackStainedGlassPane(short id) {
		super(id, "BLACK_STAINED_GLASS_PANE", (ins, f) -> {
