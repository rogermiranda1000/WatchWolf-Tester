...
public class BirchWallSign extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		BirchWallSign current = new BirchWallSign(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public BirchWallSign(short id) {
		super(id, "BIRCH_WALL_SIGN", (ins, f) -> {
	...
	public BirchWallSign(int id) {
		this((short) id);
	}

	private BirchWallSign(BirchWallSign old) {
		this(old.id);
