...
public class BrownStainedGlassPane extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("BrownStainedGlassPane block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("BrownStainedGlassPane block doesn't contain orientation " + o.name());
		BrownStainedGlassPane current = new BrownStainedGlassPane(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public BrownStainedGlassPane(short id) {
		super(id, "BROWN_STAINED_GLASS_PANE", (ins, f) -> {
	...
	public BrownStainedGlassPane(int id) {
		this((short) id);
	}

	private BrownStainedGlassPane(BrownStainedGlassPane old) {
		this(old.id);
