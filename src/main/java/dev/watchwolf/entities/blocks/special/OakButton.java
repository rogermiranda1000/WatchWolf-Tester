...
public class OakButton extends Block implements Orientable, Powerable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		OakButton current = new OakButton(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public OakButton(short id) {
		super(id, "OAK_BUTTON", (ins, f) -> {
	...
	public OakButton(int id) {
		this((short) id);
	}

	private OakButton(OakButton old) {
		this(old.id);
