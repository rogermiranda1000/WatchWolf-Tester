...
public class Stonecutter extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		Stonecutter current = new Stonecutter(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public Stonecutter(short id) {
		super(id, "STONECUTTER", (ins, f) -> {
	...
	public Stonecutter(int id) {
		this((short) id);
	}

	private Stonecutter(Stonecutter old) {
		this(old.id);
