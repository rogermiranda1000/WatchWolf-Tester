...
public class BirchTrapdoor extends Block implements Orientable, Openable, Powerable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		BirchTrapdoor current = new BirchTrapdoor(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public BirchTrapdoor(short id) {
		super(id, "BIRCH_TRAPDOOR", (ins, f) -> {
	...
	public BirchTrapdoor(int id) {
		this((short) id);
	}

	private BirchTrapdoor(BirchTrapdoor old) {
		this(old.id);
