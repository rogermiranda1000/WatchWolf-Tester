...
public class WaxedOxidizedCutCopperSlab extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("WaxedOxidizedCutCopperSlab block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("WaxedOxidizedCutCopperSlab block doesn't contain orientation " + o.name());
		WaxedOxidizedCutCopperSlab current = new WaxedOxidizedCutCopperSlab(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public WaxedOxidizedCutCopperSlab(short id) {
		super(id, "WAXED_OXIDIZED_CUT_COPPER_SLAB", (ins, f) -> {
	...
	public WaxedOxidizedCutCopperSlab(int id) {
		this((short) id);
	}

	private WaxedOxidizedCutCopperSlab(WaxedOxidizedCutCopperSlab old) {
		this(old.id);
