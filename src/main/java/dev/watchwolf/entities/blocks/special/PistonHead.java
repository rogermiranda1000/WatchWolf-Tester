...
public class PistonHead extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		PistonHead current = new PistonHead(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public PistonHead(short id) {
		super(id, "PISTON_HEAD", (ins, f) -> {
	...
	public PistonHead(int id) {
		this((short) id);
	}

	private PistonHead(PistonHead old) {
		this(old.id);
