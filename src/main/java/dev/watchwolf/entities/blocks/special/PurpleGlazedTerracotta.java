...
public class PurpleGlazedTerracotta extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		PurpleGlazedTerracotta current = new PurpleGlazedTerracotta(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public PurpleGlazedTerracotta(short id) {
		super(id, "PURPLE_GLAZED_TERRACOTTA", (ins, f) -> {
	...
	public PurpleGlazedTerracotta(int id) {
		this((short) id);
	}

	private PurpleGlazedTerracotta(PurpleGlazedTerracotta old) {
		this(old.id);
