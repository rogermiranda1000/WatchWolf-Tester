...
public class CyanWallBanner extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		CyanWallBanner current = new CyanWallBanner(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public CyanWallBanner(short id) {
		super(id, "CYAN_WALL_BANNER", (ins, f) -> {
	...
	public CyanWallBanner(int id) {
		this((short) id);
	}

	private CyanWallBanner(CyanWallBanner old) {
		this(old.id);
