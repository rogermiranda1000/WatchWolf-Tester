...
public class SmoothSandstoneStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		SmoothSandstoneStairs current = new SmoothSandstoneStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("SmoothSandstoneStairs block doesn't allow the section " + section.name());
		SmoothSandstoneStairs current = new SmoothSandstoneStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public SmoothSandstoneStairs(short id) {
		super(id, "SMOOTH_SANDSTONE_STAIRS", (ins, f) -> {
	...
	public SmoothSandstoneStairs(int id) {
		this((short) id);
	}

	private SmoothSandstoneStairs(SmoothSandstoneStairs old) {
		this(old.id);
