...
public class LightGrayGlazedTerracotta extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		LightGrayGlazedTerracotta current = new LightGrayGlazedTerracotta(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public LightGrayGlazedTerracotta(short id) {
		super(id, "LIGHT_GRAY_GLAZED_TERRACOTTA", (ins, f) -> {
	...
	public LightGrayGlazedTerracotta(int id) {
		this((short) id);
	}

	private LightGrayGlazedTerracotta(LightGrayGlazedTerracotta old) {
		this(old.id);
