...
public class PrismarineSlab extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("PrismarineSlab block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("PrismarineSlab block doesn't contain orientation " + o.name());
		PrismarineSlab current = new PrismarineSlab(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public PrismarineSlab(short id) {
		super(id, "PRISMARINE_SLAB", (ins, f) -> {
	...
	public PrismarineSlab(int id) {
		this((short) id);
	}

	private PrismarineSlab(PrismarineSlab old) {
		this(old.id);
