...
public class WaxedWeatheredCutCopperStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		WaxedWeatheredCutCopperStairs current = new WaxedWeatheredCutCopperStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("WaxedWeatheredCutCopperStairs block doesn't allow the section " + section.name());
		WaxedWeatheredCutCopperStairs current = new WaxedWeatheredCutCopperStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public WaxedWeatheredCutCopperStairs(short id) {
		super(id, "WAXED_WEATHERED_CUT_COPPER_STAIRS", (ins, f) -> {
	...
	public WaxedWeatheredCutCopperStairs(int id) {
		this((short) id);
	}

	private WaxedWeatheredCutCopperStairs(WaxedWeatheredCutCopperStairs old) {
		this(old.id);
