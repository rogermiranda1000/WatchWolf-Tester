...
public class StickyPiston extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		StickyPiston current = new StickyPiston(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("StickyPiston block doesn't allow the section " + section.name());
		StickyPiston current = new StickyPiston(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public StickyPiston(short id) {
		super(id, "STICKY_PISTON", (ins, f) -> {
		...
		this.allowedSections.add(Sectionable.Section.EXTENDED_PISTON);
		this.allowedSections.add(Sectionable.Section.PISTON);
		this.section = Sectionable.Section.EXTENDED_PISTON;
	}

	public StickyPiston(int id) {
		this((short) id);
	}

	private StickyPiston(StickyPiston old) {
		this(old.id);
