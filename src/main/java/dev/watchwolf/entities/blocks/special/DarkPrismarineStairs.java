...
public class DarkPrismarineStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		DarkPrismarineStairs current = new DarkPrismarineStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("DarkPrismarineStairs block doesn't allow the section " + section.name());
		DarkPrismarineStairs current = new DarkPrismarineStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public DarkPrismarineStairs(short id) {
		super(id, "DARK_PRISMARINE_STAIRS", (ins, f) -> {
	...
	public DarkPrismarineStairs(int id) {
		this((short) id);
	}

	private DarkPrismarineStairs(DarkPrismarineStairs old) {
		this(old.id);
