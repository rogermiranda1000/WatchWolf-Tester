...
public class WarpedFenceGate extends Block implements Orientable, Openable, Powerable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		WarpedFenceGate current = new WarpedFenceGate(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public WarpedFenceGate(short id) {
		super(id, "WARPED_FENCE_GATE", (ins, f) -> {
	...
	public WarpedFenceGate(int id) {
		this((short) id);
	}

	private WarpedFenceGate(WarpedFenceGate old) {
		this(old.id);
