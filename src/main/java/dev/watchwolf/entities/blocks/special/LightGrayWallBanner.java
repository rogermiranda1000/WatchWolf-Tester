...
public class LightGrayWallBanner extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		LightGrayWallBanner current = new LightGrayWallBanner(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public LightGrayWallBanner(short id) {
		super(id, "LIGHT_GRAY_WALL_BANNER", (ins, f) -> {
	...
	public LightGrayWallBanner(int id) {
		this((short) id);
	}

	private LightGrayWallBanner(LightGrayWallBanner old) {
		this(old.id);
