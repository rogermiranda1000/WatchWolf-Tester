...
public class OxidizedCutCopperSlab extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("OxidizedCutCopperSlab block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("OxidizedCutCopperSlab block doesn't contain orientation " + o.name());
		OxidizedCutCopperSlab current = new OxidizedCutCopperSlab(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public OxidizedCutCopperSlab(short id) {
		super(id, "OXIDIZED_CUT_COPPER_SLAB", (ins, f) -> {
	...
	public OxidizedCutCopperSlab(int id) {
		this((short) id);
	}

	private OxidizedCutCopperSlab(OxidizedCutCopperSlab old) {
		this(old.id);
