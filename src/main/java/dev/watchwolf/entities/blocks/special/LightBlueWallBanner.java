...
public class LightBlueWallBanner extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		LightBlueWallBanner current = new LightBlueWallBanner(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public LightBlueWallBanner(short id) {
		super(id, "LIGHT_BLUE_WALL_BANNER", (ins, f) -> {
	...
	public LightBlueWallBanner(int id) {
		this((short) id);
	}

	private LightBlueWallBanner(LightBlueWallBanner old) {
		this(old.id);
