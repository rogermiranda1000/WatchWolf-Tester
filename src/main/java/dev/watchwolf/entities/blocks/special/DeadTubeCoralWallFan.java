...
public class DeadTubeCoralWallFan extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		DeadTubeCoralWallFan current = new DeadTubeCoralWallFan(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public DeadTubeCoralWallFan(short id) {
		super(id, "DEAD_TUBE_CORAL_WALL_FAN", (ins, f) -> {
	...
	public DeadTubeCoralWallFan(int id) {
		this((short) id);
	}

	private DeadTubeCoralWallFan(DeadTubeCoralWallFan old) {
		this(old.id);
