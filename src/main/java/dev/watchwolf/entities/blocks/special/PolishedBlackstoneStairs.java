...
public class PolishedBlackstoneStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		PolishedBlackstoneStairs current = new PolishedBlackstoneStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("PolishedBlackstoneStairs block doesn't allow the section " + section.name());
		PolishedBlackstoneStairs current = new PolishedBlackstoneStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public PolishedBlackstoneStairs(short id) {
		super(id, "POLISHED_BLACKSTONE_STAIRS", (ins, f) -> {
	...
	public PolishedBlackstoneStairs(int id) {
		this((short) id);
	}

	private PolishedBlackstoneStairs(PolishedBlackstoneStairs old) {
		this(old.id);
