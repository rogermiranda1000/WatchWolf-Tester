...
public class DeadBrainCoralWallFan extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		DeadBrainCoralWallFan current = new DeadBrainCoralWallFan(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public DeadBrainCoralWallFan(short id) {
		super(id, "DEAD_BRAIN_CORAL_WALL_FAN", (ins, f) -> {
	...
	public DeadBrainCoralWallFan(int id) {
		this((short) id);
	}

	private DeadBrainCoralWallFan(DeadBrainCoralWallFan old) {
		this(old.id);
