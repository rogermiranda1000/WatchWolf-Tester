...
public class PlayerWallHead extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		PlayerWallHead current = new PlayerWallHead(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public PlayerWallHead(short id) {
		super(id, "PLAYER_WALL_HEAD", (ins, f) -> {
	...
	public PlayerWallHead(int id) {
		this((short) id);
	}

	private PlayerWallHead(PlayerWallHead old) {
		this(old.id);
