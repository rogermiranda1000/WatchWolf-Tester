...
public class CutCopperStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		CutCopperStairs current = new CutCopperStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("CutCopperStairs block doesn't allow the section " + section.name());
		CutCopperStairs current = new CutCopperStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public CutCopperStairs(short id) {
		super(id, "CUT_COPPER_STAIRS", (ins, f) -> {
	...
	public CutCopperStairs(int id) {
		this((short) id);
	}

	private CutCopperStairs(CutCopperStairs old) {
		this(old.id);
