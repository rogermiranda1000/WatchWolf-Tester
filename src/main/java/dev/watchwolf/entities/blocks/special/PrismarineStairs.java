...
public class PrismarineStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		PrismarineStairs current = new PrismarineStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("PrismarineStairs block doesn't allow the section " + section.name());
		PrismarineStairs current = new PrismarineStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public PrismarineStairs(short id) {
		super(id, "PRISMARINE_STAIRS", (ins, f) -> {
	...
	public PrismarineStairs(int id) {
		this((short) id);
	}

	private PrismarineStairs(PrismarineStairs old) {
		this(old.id);
