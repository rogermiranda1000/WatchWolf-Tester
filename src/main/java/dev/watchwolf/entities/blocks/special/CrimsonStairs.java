...
public class CrimsonStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		CrimsonStairs current = new CrimsonStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("CrimsonStairs block doesn't allow the section " + section.name());
		CrimsonStairs current = new CrimsonStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public CrimsonStairs(short id) {
		super(id, "CRIMSON_STAIRS", (ins, f) -> {
	...
	public CrimsonStairs(int id) {
		this((short) id);
	}

	private CrimsonStairs(CrimsonStairs old) {
		this(old.id);
