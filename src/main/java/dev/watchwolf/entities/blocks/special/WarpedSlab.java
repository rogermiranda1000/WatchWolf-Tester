...
public class WarpedSlab extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("WarpedSlab block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("WarpedSlab block doesn't contain orientation " + o.name());
		WarpedSlab current = new WarpedSlab(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public WarpedSlab(short id) {
		super(id, "WARPED_SLAB", (ins, f) -> {
	...
	public WarpedSlab(int id) {
		this((short) id);
	}

	private WarpedSlab(WarpedSlab old) {
		this(old.id);
