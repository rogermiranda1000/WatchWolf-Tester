...
public class JungleSlab extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("JungleSlab block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("JungleSlab block doesn't contain orientation " + o.name());
		JungleSlab current = new JungleSlab(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public JungleSlab(short id) {
		super(id, "JUNGLE_SLAB", (ins, f) -> {
	...
	public JungleSlab(int id) {
		this((short) id);
	}

	private JungleSlab(JungleSlab old) {
		this(old.id);
