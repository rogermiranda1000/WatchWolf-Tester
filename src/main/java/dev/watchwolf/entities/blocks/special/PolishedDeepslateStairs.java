...
public class PolishedDeepslateStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		PolishedDeepslateStairs current = new PolishedDeepslateStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("PolishedDeepslateStairs block doesn't allow the section " + section.name());
		PolishedDeepslateStairs current = new PolishedDeepslateStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public PolishedDeepslateStairs(short id) {
		super(id, "POLISHED_DEEPSLATE_STAIRS", (ins, f) -> {
	...
	public PolishedDeepslateStairs(int id) {
		this((short) id);
	}

	private PolishedDeepslateStairs(PolishedDeepslateStairs old) {
		this(old.id);
