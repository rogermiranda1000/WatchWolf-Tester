...
public class DeepslateTileWall extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("DeepslateTileWall block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("DeepslateTileWall block doesn't contain orientation " + o.name());
		DeepslateTileWall current = new DeepslateTileWall(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public DeepslateTileWall(short id) {
		super(id, "DEEPSLATE_TILE_WALL", (ins, f) -> {
	...
	public DeepslateTileWall(int id) {
		this((short) id);
	}

	private DeepslateTileWall(DeepslateTileWall old) {
		this(old.id);
