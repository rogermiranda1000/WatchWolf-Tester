...
public class SmoothStoneSlab extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("SmoothStoneSlab block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("SmoothStoneSlab block doesn't contain orientation " + o.name());
		SmoothStoneSlab current = new SmoothStoneSlab(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public SmoothStoneSlab(short id) {
		super(id, "SMOOTH_STONE_SLAB", (ins, f) -> {
	...
	public SmoothStoneSlab(int id) {
		this((short) id);
	}

	private SmoothStoneSlab(SmoothStoneSlab old) {
		this(old.id);
