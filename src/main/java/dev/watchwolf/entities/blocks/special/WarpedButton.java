...
public class WarpedButton extends Block implements Orientable, Powerable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		WarpedButton current = new WarpedButton(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public WarpedButton(short id) {
		super(id, "WARPED_BUTTON", (ins, f) -> {
	...
	public WarpedButton(int id) {
		this((short) id);
	}

	private WarpedButton(WarpedButton old) {
		this(old.id);
