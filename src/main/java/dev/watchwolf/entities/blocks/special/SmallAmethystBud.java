...
public class SmallAmethystBud extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		SmallAmethystBud current = new SmallAmethystBud(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public SmallAmethystBud(short id) {
		super(id, "SMALL_AMETHYST_BUD", (ins, f) -> {
	...
	public SmallAmethystBud(int id) {
		this((short) id);
	}

	private SmallAmethystBud(SmallAmethystBud old) {
		this(old.id);
