...
public class SculkVein extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		SculkVein current = new SculkVein(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public SculkVein(short id) {
		super(id, "SCULK_VEIN", (ins, f) -> {
	...
	public SculkVein(int id) {
		this((short) id);
	}

	private SculkVein(SculkVein old) {
		this(old.id);
