...
public class WhiteWallBanner extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		WhiteWallBanner current = new WhiteWallBanner(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public WhiteWallBanner(short id) {
		super(id, "WHITE_WALL_BANNER", (ins, f) -> {
	...
	public WhiteWallBanner(int id) {
		this((short) id);
	}

	private WhiteWallBanner(WhiteWallBanner old) {
		this(old.id);
