...
public class SpruceStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		SpruceStairs current = new SpruceStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("SpruceStairs block doesn't allow the section " + section.name());
		SpruceStairs current = new SpruceStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public SpruceStairs(short id) {
		super(id, "SPRUCE_STAIRS", (ins, f) -> {
	...
	public SpruceStairs(int id) {
		this((short) id);
	}

	private SpruceStairs(SpruceStairs old) {
		this(old.id);
