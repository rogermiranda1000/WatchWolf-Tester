...
public class BubbleCoralWallFan extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		BubbleCoralWallFan current = new BubbleCoralWallFan(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public BubbleCoralWallFan(short id) {
		super(id, "BUBBLE_CORAL_WALL_FAN", (ins, f) -> {
	...
	public BubbleCoralWallFan(int id) {
		this((short) id);
	}

	private BubbleCoralWallFan(BubbleCoralWallFan old) {
		this(old.id);
