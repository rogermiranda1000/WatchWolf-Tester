...
public class AttachedMelonStem extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		AttachedMelonStem current = new AttachedMelonStem(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public AttachedMelonStem(short id) {
		super(id, "ATTACHED_MELON_STEM", (ins, f) -> {
	...
	public AttachedMelonStem(int id) {
		this((short) id);
	}

	private AttachedMelonStem(AttachedMelonStem old) {
		this(old.id);
