...
public class JungleTrapdoor extends Block implements Orientable, Openable, Powerable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		JungleTrapdoor current = new JungleTrapdoor(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public JungleTrapdoor(short id) {
		super(id, "JUNGLE_TRAPDOOR", (ins, f) -> {
	...
	public JungleTrapdoor(int id) {
		this((short) id);
	}

	private JungleTrapdoor(JungleTrapdoor old) {
		this(old.id);
