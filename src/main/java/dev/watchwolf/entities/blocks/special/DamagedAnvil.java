...
public class DamagedAnvil extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		DamagedAnvil current = new DamagedAnvil(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public DamagedAnvil(short id) {
		super(id, "DAMAGED_ANVIL", (ins, f) -> {
	...
	public DamagedAnvil(int id) {
		this((short) id);
	}

	private DamagedAnvil(DamagedAnvil old) {
		this(old.id);
