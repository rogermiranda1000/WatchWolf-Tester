...
public class RoseBush extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("RoseBush block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("RoseBush block doesn't contain orientation " + o.name());
		RoseBush current = new RoseBush(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public RoseBush(short id) {
		super(id, "ROSE_BUSH", (ins, f) -> {
	...
	public RoseBush(int id) {
		this((short) id);
	}

	private RoseBush(RoseBush old) {
		this(old.id);
