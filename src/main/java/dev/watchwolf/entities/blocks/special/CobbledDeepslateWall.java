...
public class CobbledDeepslateWall extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("CobbledDeepslateWall block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("CobbledDeepslateWall block doesn't contain orientation " + o.name());
		CobbledDeepslateWall current = new CobbledDeepslateWall(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public CobbledDeepslateWall(short id) {
		super(id, "COBBLED_DEEPSLATE_WALL", (ins, f) -> {
	...
	public CobbledDeepslateWall(int id) {
		this((short) id);
	}

	private CobbledDeepslateWall(CobbledDeepslateWall old) {
		this(old.id);
