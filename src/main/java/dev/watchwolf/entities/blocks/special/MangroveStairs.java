...
public class MangroveStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		MangroveStairs current = new MangroveStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("MangroveStairs block doesn't allow the section " + section.name());
		MangroveStairs current = new MangroveStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public MangroveStairs(short id) {
		super(id, "MANGROVE_STAIRS", (ins, f) -> {
	...
	public MangroveStairs(int id) {
		this((short) id);
	}

	private MangroveStairs(MangroveStairs old) {
		this(old.id);
