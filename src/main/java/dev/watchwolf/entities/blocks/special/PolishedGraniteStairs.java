...
public class PolishedGraniteStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		PolishedGraniteStairs current = new PolishedGraniteStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("PolishedGraniteStairs block doesn't allow the section " + section.name());
		PolishedGraniteStairs current = new PolishedGraniteStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public PolishedGraniteStairs(short id) {
		super(id, "POLISHED_GRANITE_STAIRS", (ins, f) -> {
	...
	public PolishedGraniteStairs(int id) {
		this((short) id);
	}

	private PolishedGraniteStairs(PolishedGraniteStairs old) {
		this(old.id);
