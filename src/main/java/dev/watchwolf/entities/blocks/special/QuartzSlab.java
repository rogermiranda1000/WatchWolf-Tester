...
public class QuartzSlab extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("QuartzSlab block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("QuartzSlab block doesn't contain orientation " + o.name());
		QuartzSlab current = new QuartzSlab(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public QuartzSlab(short id) {
		super(id, "QUARTZ_SLAB", (ins, f) -> {
	...
	public QuartzSlab(int id) {
		this((short) id);
	}

	private QuartzSlab(QuartzSlab old) {
		this(old.id);
