...
public class OrangeBed extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		OrangeBed current = new OrangeBed(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("OrangeBed block doesn't allow the section " + section.name());
		OrangeBed current = new OrangeBed(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public OrangeBed(short id) {
		super(id, "ORANGE_BED", (ins, f) -> {
	...
	public OrangeBed(int id) {
		this((short) id);
	}

	private OrangeBed(OrangeBed old) {
		this(old.id);
