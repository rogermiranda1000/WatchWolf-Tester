...
public class WarpedWallSign extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		WarpedWallSign current = new WarpedWallSign(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public WarpedWallSign(short id) {
		super(id, "WARPED_WALL_SIGN", (ins, f) -> {
	...
	public WarpedWallSign(int id) {
		this((short) id);
	}

	private WarpedWallSign(WarpedWallSign old) {
		this(old.id);
