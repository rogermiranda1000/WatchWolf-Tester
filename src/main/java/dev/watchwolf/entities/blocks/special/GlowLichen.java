...
public class GlowLichen extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		GlowLichen current = new GlowLichen(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public GlowLichen(short id) {
		super(id, "GLOW_LICHEN", (ins, f) -> {
	...
	public GlowLichen(int id) {
		this((short) id);
	}

	private GlowLichen(GlowLichen old) {
		this(old.id);
