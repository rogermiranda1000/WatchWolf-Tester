...
public class DarkPrismarineSlab extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("DarkPrismarineSlab block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("DarkPrismarineSlab block doesn't contain orientation " + o.name());
		DarkPrismarineSlab current = new DarkPrismarineSlab(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public DarkPrismarineSlab(short id) {
		super(id, "DARK_PRISMARINE_SLAB", (ins, f) -> {
	...
	public DarkPrismarineSlab(int id) {
		this((short) id);
	}

	private DarkPrismarineSlab(DarkPrismarineSlab old) {
		this(old.id);
