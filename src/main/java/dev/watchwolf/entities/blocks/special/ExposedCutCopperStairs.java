...
public class ExposedCutCopperStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		ExposedCutCopperStairs current = new ExposedCutCopperStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("ExposedCutCopperStairs block doesn't allow the section " + section.name());
		ExposedCutCopperStairs current = new ExposedCutCopperStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public ExposedCutCopperStairs(short id) {
		super(id, "EXPOSED_CUT_COPPER_STAIRS", (ins, f) -> {
	...
	public ExposedCutCopperStairs(int id) {
		this((short) id);
	}

	private ExposedCutCopperStairs(ExposedCutCopperStairs old) {
		this(old.id);
