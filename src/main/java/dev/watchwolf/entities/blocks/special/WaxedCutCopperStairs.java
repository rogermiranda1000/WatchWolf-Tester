...
public class WaxedCutCopperStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		WaxedCutCopperStairs current = new WaxedCutCopperStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("WaxedCutCopperStairs block doesn't allow the section " + section.name());
		WaxedCutCopperStairs current = new WaxedCutCopperStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public WaxedCutCopperStairs(short id) {
		super(id, "WAXED_CUT_COPPER_STAIRS", (ins, f) -> {
	...
	public WaxedCutCopperStairs(int id) {
		this((short) id);
	}

	private WaxedCutCopperStairs(WaxedCutCopperStairs old) {
		this(old.id);
