...
public class BlueShulkerBox extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		BlueShulkerBox current = new BlueShulkerBox(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public BlueShulkerBox(short id) {
		super(id, "BLUE_SHULKER_BOX", (ins, f) -> {
	...
	public BlueShulkerBox(int id) {
		this((short) id);
	}

	private BlueShulkerBox(BlueShulkerBox old) {
		this(old.id);
