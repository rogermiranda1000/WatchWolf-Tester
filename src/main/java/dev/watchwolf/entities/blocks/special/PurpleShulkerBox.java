...
public class PurpleShulkerBox extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		PurpleShulkerBox current = new PurpleShulkerBox(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public PurpleShulkerBox(short id) {
		super(id, "PURPLE_SHULKER_BOX", (ins, f) -> {
	...
	public PurpleShulkerBox(int id) {
		this((short) id);
	}

	private PurpleShulkerBox(PurpleShulkerBox old) {
		this(old.id);
