...
public class GreenGlazedTerracotta extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		GreenGlazedTerracotta current = new GreenGlazedTerracotta(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public GreenGlazedTerracotta(short id) {
		super(id, "GREEN_GLAZED_TERRACOTTA", (ins, f) -> {
	...
	public GreenGlazedTerracotta(int id) {
		this((short) id);
	}

	private GreenGlazedTerracotta(GreenGlazedTerracotta old) {
		this(old.id);
