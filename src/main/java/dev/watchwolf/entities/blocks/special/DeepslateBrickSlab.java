...
public class DeepslateBrickSlab extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("DeepslateBrickSlab block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("DeepslateBrickSlab block doesn't contain orientation " + o.name());
		DeepslateBrickSlab current = new DeepslateBrickSlab(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public DeepslateBrickSlab(short id) {
		super(id, "DEEPSLATE_BRICK_SLAB", (ins, f) -> {
	...
	public DeepslateBrickSlab(int id) {
		this((short) id);
	}

	private DeepslateBrickSlab(DeepslateBrickSlab old) {
		this(old.id);
