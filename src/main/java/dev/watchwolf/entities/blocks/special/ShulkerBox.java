...
public class ShulkerBox extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		ShulkerBox current = new ShulkerBox(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public ShulkerBox(short id) {
		super(id, "SHULKER_BOX", (ins, f) -> {
	...
	public ShulkerBox(int id) {
		this((short) id);
	}

	private ShulkerBox(ShulkerBox old) {
		this(old.id);
