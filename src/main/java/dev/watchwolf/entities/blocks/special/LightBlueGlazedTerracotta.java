...
public class LightBlueGlazedTerracotta extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		LightBlueGlazedTerracotta current = new LightBlueGlazedTerracotta(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public LightBlueGlazedTerracotta(short id) {
		super(id, "LIGHT_BLUE_GLAZED_TERRACOTTA", (ins, f) -> {
	...
	public LightBlueGlazedTerracotta(int id) {
		this((short) id);
	}

	private LightBlueGlazedTerracotta(LightBlueGlazedTerracotta old) {
		this(old.id);
