...
public class DeepslateTileSlab extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("DeepslateTileSlab block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("DeepslateTileSlab block doesn't contain orientation " + o.name());
		DeepslateTileSlab current = new DeepslateTileSlab(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public DeepslateTileSlab(short id) {
		super(id, "DEEPSLATE_TILE_SLAB", (ins, f) -> {
	...
	public DeepslateTileSlab(int id) {
		this((short) id);
	}

	private DeepslateTileSlab(DeepslateTileSlab old) {
		this(old.id);
