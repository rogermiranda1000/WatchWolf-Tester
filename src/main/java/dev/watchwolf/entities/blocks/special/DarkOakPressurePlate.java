...
public class DarkOakPressurePlate extends Block implements Powerable {
	/*   --- POWERABLE INTERFACE ---   */
	@RelevantBlockData
	...
	public Powerable setPowered(boolean val) {
		DarkOakPressurePlate current = new DarkOakPressurePlate(this);
		current.powered = val;
		return current;
	}
	...
	public DarkOakPressurePlate(short id) {
		super(id, "DARK_OAK_PRESSURE_PLATE", (ins, f) -> {
