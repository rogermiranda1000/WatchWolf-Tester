...
public class FireCoralWallFan extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		FireCoralWallFan current = new FireCoralWallFan(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public FireCoralWallFan(short id) {
		super(id, "FIRE_CORAL_WALL_FAN", (ins, f) -> {
	...
	public FireCoralWallFan(int id) {
		this((short) id);
	}

	private FireCoralWallFan(FireCoralWallFan old) {
		this(old.id);
