...
public class GlassPane extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("GlassPane block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("GlassPane block doesn't contain orientation " + o.name());
		GlassPane current = new GlassPane(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public GlassPane(short id) {
		super(id, "GLASS_PANE", (ins, f) -> {
	...
	private GlassPane(GlassPane old) {
		this(old.id);
