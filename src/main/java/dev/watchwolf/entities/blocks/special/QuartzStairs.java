...
public class QuartzStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		QuartzStairs current = new QuartzStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("QuartzStairs block doesn't allow the section " + section.name());
		QuartzStairs current = new QuartzStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public QuartzStairs(short id) {
		super(id, "QUARTZ_STAIRS", (ins, f) -> {
	...
	public QuartzStairs(int id) {
		this((short) id);
	}

	private QuartzStairs(QuartzStairs old) {
		this(old.id);
