...
public class MossyStoneBrickStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		MossyStoneBrickStairs current = new MossyStoneBrickStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("MossyStoneBrickStairs block doesn't allow the section " + section.name());
		MossyStoneBrickStairs current = new MossyStoneBrickStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public MossyStoneBrickStairs(short id) {
		super(id, "MOSSY_STONE_BRICK_STAIRS", (ins, f) -> {
	...
	public MossyStoneBrickStairs(int id) {
		this((short) id);
	}

	private MossyStoneBrickStairs(MossyStoneBrickStairs old) {
		this(old.id);
