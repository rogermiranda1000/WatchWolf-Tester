...
public class BrownBed extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		BrownBed current = new BrownBed(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("BrownBed block doesn't allow the section " + section.name());
		BrownBed current = new BrownBed(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public BrownBed(short id) {
		super(id, "BROWN_BED", (ins, f) -> {
	...
	public BrownBed(int id) {
		this((short) id);
	}

	private BrownBed(BrownBed old) {
		this(old.id);
