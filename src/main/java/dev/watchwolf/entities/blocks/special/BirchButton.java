...
public class BirchButton extends Block implements Orientable, Powerable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		BirchButton current = new BirchButton(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public BirchButton(short id) {
		super(id, "BIRCH_BUTTON", (ins, f) -> {
	...
	public BirchButton(int id) {
		this((short) id);
	}

	private BirchButton(BirchButton old) {
		this(old.id);
