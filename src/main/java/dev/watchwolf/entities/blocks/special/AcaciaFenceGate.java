...
public class AcaciaFenceGate extends Block implements Orientable, Openable, Powerable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		AcaciaFenceGate current = new AcaciaFenceGate(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public AcaciaFenceGate(short id) {
		super(id, "ACACIA_FENCE_GATE", (ins, f) -> {
	...
	public AcaciaFenceGate(int id) {
		this((short) id);
	}

	private AcaciaFenceGate(AcaciaFenceGate old) {
		this(old.id);
