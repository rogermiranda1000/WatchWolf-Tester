...
public class BeeNest extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		BeeNest current = new BeeNest(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public BeeNest(short id) {
		super(id, "BEE_NEST", (ins, f) -> {
	...
	public BeeNest(int id) {
		this((short) id);
	}

	private BeeNest(BeeNest old) {
		this(old.id);
