...
public class DragonWallHead extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		DragonWallHead current = new DragonWallHead(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public DragonWallHead(short id) {
		super(id, "DRAGON_WALL_HEAD", (ins, f) -> {
	...
	public DragonWallHead(int id) {
		this((short) id);
	}

	private DragonWallHead(DragonWallHead old) {
		this(old.id);
