...
public class RedGlazedTerracotta extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		RedGlazedTerracotta current = new RedGlazedTerracotta(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public RedGlazedTerracotta(short id) {
		super(id, "RED_GLAZED_TERRACOTTA", (ins, f) -> {
	...
	public RedGlazedTerracotta(int id) {
		this((short) id);
	}

	private RedGlazedTerracotta(RedGlazedTerracotta old) {
		this(old.id);
