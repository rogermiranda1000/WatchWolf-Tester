...
public class MossyCobblestoneSlab extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("MossyCobblestoneSlab block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("MossyCobblestoneSlab block doesn't contain orientation " + o.name());
		MossyCobblestoneSlab current = new MossyCobblestoneSlab(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public MossyCobblestoneSlab(short id) {
		super(id, "MOSSY_COBBLESTONE_SLAB", (ins, f) -> {
	...
	public MossyCobblestoneSlab(int id) {
		this((short) id);
	}

	private MossyCobblestoneSlab(MossyCobblestoneSlab old) {
		this(old.id);
