...
public class TrappedChest extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		TrappedChest current = new TrappedChest(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public TrappedChest(short id) {
		super(id, "TRAPPED_CHEST", (ins, f) -> {
	...
	public TrappedChest(int id) {
		this((short) id);
	}

	private TrappedChest(TrappedChest old) {
		this(old.id);
