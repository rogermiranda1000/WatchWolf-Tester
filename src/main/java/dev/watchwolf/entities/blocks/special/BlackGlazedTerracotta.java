...
public class BlackGlazedTerracotta extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		BlackGlazedTerracotta current = new BlackGlazedTerracotta(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public BlackGlazedTerracotta(short id) {
		super(id, "BLACK_GLAZED_TERRACOTTA", (ins, f) -> {
	...
	public BlackGlazedTerracotta(int id) {
		this((short) id);
	}

	private BlackGlazedTerracotta(BlackGlazedTerracotta old) {
		this(old.id);
