...
public class RedSandstoneStairs extends Block implements Orientable, Sectionable {
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("RedSandstoneStairs block doesn't allow the section " + section.name());
		RedSandstoneStairs current = new RedSandstoneStairs(this);
	...
	public RedSandstoneStairs(short id) {
		super(id, "RED_SANDSTONE_STAIRS", (ins, f) -> {
