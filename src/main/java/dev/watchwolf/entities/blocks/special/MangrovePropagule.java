...
public class MangrovePropagule extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("MangrovePropagule block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("MangrovePropagule block doesn't contain orientation " + o.name());
		MangrovePropagule current = new MangrovePropagule(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public MangrovePropagule(short id) {
		super(id, "MANGROVE_PROPAGULE", (ins, f) -> {
	...
	public MangrovePropagule(int id) {
		this((short) id);
	}

	private MangrovePropagule(MangrovePropagule old) {
		this(old.id);
