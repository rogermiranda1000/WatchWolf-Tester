...
public class GrayGlazedTerracotta extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		GrayGlazedTerracotta current = new GrayGlazedTerracotta(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public GrayGlazedTerracotta(short id) {
		super(id, "GRAY_GLAZED_TERRACOTTA", (ins, f) -> {
	...
	public GrayGlazedTerracotta(int id) {
		this((short) id);
	}

	private GrayGlazedTerracotta(GrayGlazedTerracotta old) {
		this(old.id);
