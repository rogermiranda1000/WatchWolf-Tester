...
public class Beehive extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		Beehive current = new Beehive(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public Beehive(short id) {
		super(id, "BEEHIVE", (ins, f) -> {
