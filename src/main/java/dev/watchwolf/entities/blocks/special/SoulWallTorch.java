...
public class SoulWallTorch extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		SoulWallTorch current = new SoulWallTorch(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public SoulWallTorch(short id) {
		super(id, "SOUL_WALL_TORCH", (ins, f) -> {
	...
	public SoulWallTorch(int id) {
		this((short) id);
	}

	private SoulWallTorch(SoulWallTorch old) {
		this(old.id);
