...
public class GreenShulkerBox extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		GreenShulkerBox current = new GreenShulkerBox(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public GreenShulkerBox(short id) {
		super(id, "GREEN_SHULKER_BOX", (ins, f) -> {
	...
	public GreenShulkerBox(int id) {
		this((short) id);
	}

	private GreenShulkerBox(GreenShulkerBox old) {
		this(old.id);
