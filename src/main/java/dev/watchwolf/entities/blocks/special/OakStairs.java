...
public class OakStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		OakStairs current = new OakStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("OakStairs block doesn't allow the section " + section.name());
		OakStairs current = new OakStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public OakStairs(short id) {
		super(id, "OAK_STAIRS", (ins, f) -> {
	...
	public OakStairs(int id) {
		this((short) id);
	}

	private OakStairs(OakStairs old) {
		this(old.id);
