...
public class JungleStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		JungleStairs current = new JungleStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("JungleStairs block doesn't allow the section " + section.name());
		JungleStairs current = new JungleStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public JungleStairs(short id) {
		super(id, "JUNGLE_STAIRS", (ins, f) -> {
	...
	public JungleStairs(int id) {
		this((short) id);
	}

	private JungleStairs(JungleStairs old) {
		this(old.id);
