...
public class AndesiteStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		AndesiteStairs current = new AndesiteStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("AndesiteStairs block doesn't allow the section " + section.name());
		AndesiteStairs current = new AndesiteStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public AndesiteStairs(short id) {
		super(id, "ANDESITE_STAIRS", (ins, f) -> {
	...
	public AndesiteStairs(int id) {
		this((short) id);
	}

	private AndesiteStairs(AndesiteStairs old) {
		this(old.id);
