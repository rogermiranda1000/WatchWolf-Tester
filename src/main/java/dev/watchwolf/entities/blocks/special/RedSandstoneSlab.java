...
public class RedSandstoneSlab extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("RedSandstoneSlab block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("RedSandstoneSlab block doesn't contain orientation " + o.name());
		RedSandstoneSlab current = new RedSandstoneSlab(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public RedSandstoneSlab(short id) {
		super(id, "RED_SANDSTONE_SLAB", (ins, f) -> {
	...
	public RedSandstoneSlab(int id) {
		this((short) id);
	}

	private RedSandstoneSlab(RedSandstoneSlab old) {
		this(old.id);
