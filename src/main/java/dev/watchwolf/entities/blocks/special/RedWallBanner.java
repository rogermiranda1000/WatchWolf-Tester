...
public class RedWallBanner extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		RedWallBanner current = new RedWallBanner(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public RedWallBanner(short id) {
		super(id, "RED_WALL_BANNER", (ins, f) -> {
	...
	public RedWallBanner(int id) {
		this((short) id);
	}

	private RedWallBanner(RedWallBanner old) {
		this(old.id);
