...
public class WaxedCutCopperSlab extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("WaxedCutCopperSlab block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("WaxedCutCopperSlab block doesn't contain orientation " + o.name());
		WaxedCutCopperSlab current = new WaxedCutCopperSlab(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public WaxedCutCopperSlab(short id) {
		super(id, "WAXED_CUT_COPPER_SLAB", (ins, f) -> {
	...
	public WaxedCutCopperSlab(int id) {
		this((short) id);
	}

	private WaxedCutCopperSlab(WaxedCutCopperSlab old) {
		this(old.id);
