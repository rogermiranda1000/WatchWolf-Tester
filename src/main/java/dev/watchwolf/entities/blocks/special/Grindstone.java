...
public class Grindstone extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		Grindstone current = new Grindstone(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public Grindstone(short id) {
		super(id, "GRINDSTONE", (ins, f) -> {
	...
	private Grindstone(Grindstone old) {
		this(old.id);
