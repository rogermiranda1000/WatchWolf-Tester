...
public class GreenWallBanner extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		GreenWallBanner current = new GreenWallBanner(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public GreenWallBanner(short id) {
		super(id, "GREEN_WALL_BANNER", (ins, f) -> {
	...
	public GreenWallBanner(int id) {
		this((short) id);
	}

	private GreenWallBanner(GreenWallBanner old) {
		this(old.id);
