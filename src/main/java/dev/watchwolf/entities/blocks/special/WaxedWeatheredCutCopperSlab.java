...
public class WaxedWeatheredCutCopperSlab extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("WaxedWeatheredCutCopperSlab block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("WaxedWeatheredCutCopperSlab block doesn't contain orientation " + o.name());
		WaxedWeatheredCutCopperSlab current = new WaxedWeatheredCutCopperSlab(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public WaxedWeatheredCutCopperSlab(short id) {
		super(id, "WAXED_WEATHERED_CUT_COPPER_SLAB", (ins, f) -> {
	...
	public WaxedWeatheredCutCopperSlab(int id) {
		this((short) id);
	}

	private WaxedWeatheredCutCopperSlab(WaxedWeatheredCutCopperSlab old) {
		this(old.id);
