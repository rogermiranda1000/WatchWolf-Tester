...
public class Hopper extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		Hopper current = new Hopper(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public Hopper(short id) {
		super(id, "HOPPER", (ins, f) -> {
	...
	public Hopper(int id) {
		this((short) id);
	}

	private Hopper(Hopper old) {
		this(old.id);
