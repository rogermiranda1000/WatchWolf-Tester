...
public class MudBrickWall extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("MudBrickWall block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("MudBrickWall block doesn't contain orientation " + o.name());
		MudBrickWall current = new MudBrickWall(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public MudBrickWall(short id) {
		super(id, "MUD_BRICK_WALL", (ins, f) -> {
	...
	public MudBrickWall(int id) {
		this((short) id);
	}

	private MudBrickWall(MudBrickWall old) {
		this(old.id);
