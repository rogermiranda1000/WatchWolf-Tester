...
public class WhiteBed extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		WhiteBed current = new WhiteBed(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("WhiteBed block doesn't allow the section " + section.name());
		WhiteBed current = new WhiteBed(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public WhiteBed(short id) {
		super(id, "WHITE_BED", (ins, f) -> {
	...
	public WhiteBed(int id) {
		this((short) id);
	}

	private WhiteBed(WhiteBed old) {
		this(old.id);
