...
public class BlackShulkerBox extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		BlackShulkerBox current = new BlackShulkerBox(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public BlackShulkerBox(short id) {
		super(id, "BLACK_SHULKER_BOX", (ins, f) -> {
	...
	public BlackShulkerBox(int id) {
		this((short) id);
	}

	private BlackShulkerBox(BlackShulkerBox old) {
		this(old.id);
