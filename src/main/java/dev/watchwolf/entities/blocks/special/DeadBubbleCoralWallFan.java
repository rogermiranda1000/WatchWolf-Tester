...
public class DeadBubbleCoralWallFan extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		DeadBubbleCoralWallFan current = new DeadBubbleCoralWallFan(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public DeadBubbleCoralWallFan(short id) {
		super(id, "DEAD_BUBBLE_CORAL_WALL_FAN", (ins, f) -> {
	...
	public DeadBubbleCoralWallFan(int id) {
		this((short) id);
	}

	private DeadBubbleCoralWallFan(DeadBubbleCoralWallFan old) {
		this(old.id);
