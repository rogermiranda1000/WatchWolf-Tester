...
public class YellowWallBanner extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		YellowWallBanner current = new YellowWallBanner(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public YellowWallBanner(short id) {
		super(id, "YELLOW_WALL_BANNER", (ins, f) -> {
	...
	public YellowWallBanner(int id) {
		this((short) id);
	}

	private YellowWallBanner(YellowWallBanner old) {
		this(old.id);
