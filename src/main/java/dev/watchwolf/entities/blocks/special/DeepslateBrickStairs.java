...
public class DeepslateBrickStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		DeepslateBrickStairs current = new DeepslateBrickStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("DeepslateBrickStairs block doesn't allow the section " + section.name());
		DeepslateBrickStairs current = new DeepslateBrickStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public DeepslateBrickStairs(short id) {
		super(id, "DEEPSLATE_BRICK_STAIRS", (ins, f) -> {
	...
	public DeepslateBrickStairs(int id) {
		this((short) id);
	}

	private DeepslateBrickStairs(DeepslateBrickStairs old) {
		this(old.id);
