...
public class PurpleBed extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		PurpleBed current = new PurpleBed(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("PurpleBed block doesn't allow the section " + section.name());
		PurpleBed current = new PurpleBed(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public PurpleBed(short id) {
		super(id, "PURPLE_BED", (ins, f) -> {
	...
	public PurpleBed(int id) {
		this((short) id);
	}

	private PurpleBed(PurpleBed old) {
		this(old.id);
