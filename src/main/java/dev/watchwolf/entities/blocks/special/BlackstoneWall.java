...
public class BlackstoneWall extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("BlackstoneWall block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("BlackstoneWall block doesn't contain orientation " + o.name());
		BlackstoneWall current = new BlackstoneWall(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public BlackstoneWall(short id) {
		super(id, "BLACKSTONE_WALL", (ins, f) -> {
	...
	public BlackstoneWall(int id) {
		this((short) id);
	}

	private BlackstoneWall(BlackstoneWall old) {
		this(old.id);
