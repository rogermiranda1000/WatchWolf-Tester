...
public class DioriteSlab extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("DioriteSlab block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("DioriteSlab block doesn't contain orientation " + o.name());
		DioriteSlab current = new DioriteSlab(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public DioriteSlab(short id) {
		super(id, "DIORITE_SLAB", (ins, f) -> {
	...
	public DioriteSlab(int id) {
		this((short) id);
	}

	private DioriteSlab(DioriteSlab old) {
		this(old.id);
