...
public class HornCoralWallFan extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		HornCoralWallFan current = new HornCoralWallFan(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public HornCoralWallFan(short id) {
		super(id, "HORN_CORAL_WALL_FAN", (ins, f) -> {
	...
	public HornCoralWallFan(int id) {
		this((short) id);
	}

	private HornCoralWallFan(HornCoralWallFan old) {
		this(old.id);
