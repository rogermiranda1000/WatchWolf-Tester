...
public class MossyCobblestoneWall extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("MossyCobblestoneWall block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("MossyCobblestoneWall block doesn't contain orientation " + o.name());
		MossyCobblestoneWall current = new MossyCobblestoneWall(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public MossyCobblestoneWall(short id) {
		super(id, "MOSSY_COBBLESTONE_WALL", (ins, f) -> {
	...
	public MossyCobblestoneWall(int id) {
		this((short) id);
	}

	private MossyCobblestoneWall(MossyCobblestoneWall old) {
		this(old.id);
