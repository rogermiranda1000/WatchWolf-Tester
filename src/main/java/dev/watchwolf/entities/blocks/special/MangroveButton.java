...
public class MangroveButton extends Block implements Orientable, Powerable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		MangroveButton current = new MangroveButton(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public MangroveButton(short id) {
		super(id, "MANGROVE_BUTTON", (ins, f) -> {
	...
	public MangroveButton(int id) {
		this((short) id);
	}

	private MangroveButton(MangroveButton old) {
		this(old.id);
