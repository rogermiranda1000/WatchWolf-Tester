...
public class SandstoneStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		SandstoneStairs current = new SandstoneStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("SandstoneStairs block doesn't allow the section " + section.name());
		SandstoneStairs current = new SandstoneStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public SandstoneStairs(short id) {
		super(id, "SANDSTONE_STAIRS", (ins, f) -> {
	...
	public SandstoneStairs(int id) {
		this((short) id);
	}

	private SandstoneStairs(SandstoneStairs old) {
		this(old.id);
