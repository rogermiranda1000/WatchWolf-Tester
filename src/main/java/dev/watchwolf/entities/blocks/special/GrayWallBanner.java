...
public class GrayWallBanner extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		GrayWallBanner current = new GrayWallBanner(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public GrayWallBanner(short id) {
		super(id, "GRAY_WALL_BANNER", (ins, f) -> {
	...
	public GrayWallBanner(int id) {
		this((short) id);
	}

	private GrayWallBanner(GrayWallBanner old) {
		this(old.id);
