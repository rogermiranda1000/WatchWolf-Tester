...
public class OakTrapdoor extends Block implements Orientable, Openable, Powerable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		OakTrapdoor current = new OakTrapdoor(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public OakTrapdoor(short id) {
		super(id, "OAK_TRAPDOOR", (ins, f) -> {
	...
	public OakTrapdoor(int id) {
		this((short) id);
	}

	private OakTrapdoor(OakTrapdoor old) {
		this(old.id);
