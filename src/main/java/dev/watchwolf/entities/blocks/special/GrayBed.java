...
public class GrayBed extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		GrayBed current = new GrayBed(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("GrayBed block doesn't allow the section " + section.name());
		GrayBed current = new GrayBed(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public GrayBed(short id) {
		super(id, "GRAY_BED", (ins, f) -> {
	...
	public GrayBed(int id) {
		this((short) id);
	}

	private GrayBed(GrayBed old) {
		this(old.id);
