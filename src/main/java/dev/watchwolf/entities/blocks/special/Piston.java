...
public class Piston extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		Piston current = new Piston(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("Piston block doesn't allow the section " + section.name());
		Piston current = new Piston(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public Piston(short id) {
		super(id, "PISTON", (ins, f) -> {
