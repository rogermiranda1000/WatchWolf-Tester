...
public class PinkBed extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		PinkBed current = new PinkBed(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("PinkBed block doesn't allow the section " + section.name());
		PinkBed current = new PinkBed(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public PinkBed(short id) {
		super(id, "PINK_BED", (ins, f) -> {
	...
	public PinkBed(int id) {
		this((short) id);
	}

	private PinkBed(PinkBed old) {
		this(old.id);
