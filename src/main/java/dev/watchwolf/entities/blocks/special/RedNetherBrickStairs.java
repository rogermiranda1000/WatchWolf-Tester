...
public class RedNetherBrickStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		RedNetherBrickStairs current = new RedNetherBrickStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("RedNetherBrickStairs block doesn't allow the section " + section.name());
		RedNetherBrickStairs current = new RedNetherBrickStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public RedNetherBrickStairs(short id) {
		super(id, "RED_NETHER_BRICK_STAIRS", (ins, f) -> {
	...
	public RedNetherBrickStairs(int id) {
		this((short) id);
	}

	private RedNetherBrickStairs(RedNetherBrickStairs old) {
		this(old.id);
