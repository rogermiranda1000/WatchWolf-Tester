...
public class MangroveWallSign extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		MangroveWallSign current = new MangroveWallSign(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public MangroveWallSign(short id) {
		super(id, "MANGROVE_WALL_SIGN", (ins, f) -> {
	...
	public MangroveWallSign(int id) {
		this((short) id);
	}

	private MangroveWallSign(MangroveWallSign old) {
		this(old.id);
