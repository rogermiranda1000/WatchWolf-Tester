...
public class WarpedDoor extends Block implements Orientable, Hinged, Openable, Powerable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		WarpedDoor current = new WarpedDoor(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public WarpedDoor(short id) {
		super(id, "WARPED_DOOR", (ins, f) -> {
	...
	public WarpedDoor(int id) {
		this((short) id);
	}

	private WarpedDoor(WarpedDoor old) {
		this(old.id);
