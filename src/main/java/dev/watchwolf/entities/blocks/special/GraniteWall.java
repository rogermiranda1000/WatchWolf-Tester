...
public class GraniteWall extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("GraniteWall block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("GraniteWall block doesn't contain orientation " + o.name());
		GraniteWall current = new GraniteWall(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public GraniteWall(short id) {
		super(id, "GRANITE_WALL", (ins, f) -> {
	...
	public GraniteWall(int id) {
		this((short) id);
	}

	private GraniteWall(GraniteWall old) {
		this(old.id);
