...
public class DioriteStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		DioriteStairs current = new DioriteStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("DioriteStairs block doesn't allow the section " + section.name());
		DioriteStairs current = new DioriteStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public DioriteStairs(short id) {
		super(id, "DIORITE_STAIRS", (ins, f) -> {
	...
	public DioriteStairs(int id) {
		this((short) id);
	}

	private DioriteStairs(DioriteStairs old) {
		this(old.id);
