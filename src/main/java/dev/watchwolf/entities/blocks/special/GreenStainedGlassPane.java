...
public class GreenStainedGlassPane extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("GreenStainedGlassPane block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("GreenStainedGlassPane block doesn't contain orientation " + o.name());
		GreenStainedGlassPane current = new GreenStainedGlassPane(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public GreenStainedGlassPane(short id) {
		super(id, "GREEN_STAINED_GLASS_PANE", (ins, f) -> {
	...
	public GreenStainedGlassPane(int id) {
		this((short) id);
	}

	private GreenStainedGlassPane(GreenStainedGlassPane old) {
		this(old.id);
