...
public class PinkGlazedTerracotta extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		PinkGlazedTerracotta current = new PinkGlazedTerracotta(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public PinkGlazedTerracotta(short id) {
		super(id, "PINK_GLAZED_TERRACOTTA", (ins, f) -> {
	...
	public PinkGlazedTerracotta(int id) {
		this((short) id);
	}

	private PinkGlazedTerracotta(PinkGlazedTerracotta old) {
		this(old.id);
