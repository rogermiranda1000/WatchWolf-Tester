...
public class EndStoneBrickStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		EndStoneBrickStairs current = new EndStoneBrickStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("EndStoneBrickStairs block doesn't allow the section " + section.name());
		EndStoneBrickStairs current = new EndStoneBrickStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public EndStoneBrickStairs(short id) {
		super(id, "END_STONE_BRICK_STAIRS", (ins, f) -> {
	...
	public EndStoneBrickStairs(int id) {
		this((short) id);
	}

	private EndStoneBrickStairs(EndStoneBrickStairs old) {
		this(old.id);
