...
public class RedstoneWallTorch extends Block implements Orientable, Ignitable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		RedstoneWallTorch current = new RedstoneWallTorch(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public RedstoneWallTorch(short id) {
		super(id, "REDSTONE_WALL_TORCH", (ins, f) -> {
	...
	public RedstoneWallTorch(int id) {
		this((short) id);
	}

	private RedstoneWallTorch(RedstoneWallTorch old) {
		this(old.id);
