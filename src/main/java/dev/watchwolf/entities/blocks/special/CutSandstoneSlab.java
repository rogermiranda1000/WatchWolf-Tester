...
public class CutSandstoneSlab extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("CutSandstoneSlab block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("CutSandstoneSlab block doesn't contain orientation " + o.name());
		CutSandstoneSlab current = new CutSandstoneSlab(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public CutSandstoneSlab(short id) {
		super(id, "CUT_SANDSTONE_SLAB", (ins, f) -> {
	...
	public CutSandstoneSlab(int id) {
		this((short) id);
	}

	private CutSandstoneSlab(CutSandstoneSlab old) {
		this(old.id);
