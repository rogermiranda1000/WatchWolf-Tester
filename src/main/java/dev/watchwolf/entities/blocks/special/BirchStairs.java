...
public class BirchStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		BirchStairs current = new BirchStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("BirchStairs block doesn't allow the section " + section.name());
		BirchStairs current = new BirchStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public BirchStairs(short id) {
		super(id, "BIRCH_STAIRS", (ins, f) -> {
	...
	public BirchStairs(int id) {
		this((short) id);
	}

	private BirchStairs(BirchStairs old) {
		this(old.id);
