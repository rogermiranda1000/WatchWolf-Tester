...
public class MovingPiston extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		MovingPiston current = new MovingPiston(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public MovingPiston(short id) {
		super(id, "MOVING_PISTON", (ins, f) -> {
	...
	private MovingPiston(MovingPiston old) {
		this(old.id);
