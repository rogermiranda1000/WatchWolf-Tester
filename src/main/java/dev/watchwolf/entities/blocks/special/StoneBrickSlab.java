...
public class StoneBrickSlab extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("StoneBrickSlab block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("StoneBrickSlab block doesn't contain orientation " + o.name());
		StoneBrickSlab current = new StoneBrickSlab(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public StoneBrickSlab(short id) {
		super(id, "STONE_BRICK_SLAB", (ins, f) -> {
	...
	public StoneBrickSlab(int id) {
		this((short) id);
	}

	private StoneBrickSlab(StoneBrickSlab old) {
		this(old.id);
