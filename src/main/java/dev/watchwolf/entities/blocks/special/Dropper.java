...
public class Dropper extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		Dropper current = new Dropper(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public Dropper(short id) {
		super(id, "DROPPER", (ins, f) -> {
	...
	public Dropper(int id) {
		this((short) id);
	}

	private Dropper(Dropper old) {
		this(old.id);
