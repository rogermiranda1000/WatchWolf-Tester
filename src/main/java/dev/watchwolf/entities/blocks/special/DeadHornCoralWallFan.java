...
public class DeadHornCoralWallFan extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		DeadHornCoralWallFan current = new DeadHornCoralWallFan(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public DeadHornCoralWallFan(short id) {
		super(id, "DEAD_HORN_CORAL_WALL_FAN", (ins, f) -> {
	...
	public DeadHornCoralWallFan(int id) {
		this((short) id);
	}

	private DeadHornCoralWallFan(DeadHornCoralWallFan old) {
		this(old.id);
