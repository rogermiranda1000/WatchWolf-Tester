...
public class AcaciaButton extends Block implements Orientable, Powerable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		AcaciaButton current = new AcaciaButton(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public AcaciaButton(short id) {
		super(id, "ACACIA_BUTTON", (ins, f) -> {
	...
	public AcaciaButton(int id) {
		this((short) id);
	}

	private AcaciaButton(AcaciaButton old) {
		this(old.id);
