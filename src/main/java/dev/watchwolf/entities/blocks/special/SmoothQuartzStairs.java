...
public class SmoothQuartzStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		SmoothQuartzStairs current = new SmoothQuartzStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("SmoothQuartzStairs block doesn't allow the section " + section.name());
		SmoothQuartzStairs current = new SmoothQuartzStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public SmoothQuartzStairs(short id) {
		super(id, "SMOOTH_QUARTZ_STAIRS", (ins, f) -> {
	...
	public SmoothQuartzStairs(int id) {
		this((short) id);
	}

	private SmoothQuartzStairs(SmoothQuartzStairs old) {
		this(old.id);
