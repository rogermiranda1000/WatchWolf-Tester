...
public class SandstoneWall extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("SandstoneWall block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("SandstoneWall block doesn't contain orientation " + o.name());
		SandstoneWall current = new SandstoneWall(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public SandstoneWall(short id) {
		super(id, "SANDSTONE_WALL", (ins, f) -> {
	...
	public SandstoneWall(int id) {
		this((short) id);
	}

	private SandstoneWall(SandstoneWall old) {
		this(old.id);
