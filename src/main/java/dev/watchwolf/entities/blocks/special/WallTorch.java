...
public class WallTorch extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		WallTorch current = new WallTorch(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public WallTorch(short id) {
		super(id, "WALL_TORCH", (ins, f) -> {
	...
	private WallTorch(WallTorch old) {
		this(old.id);
