...
public class YellowShulkerBox extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		YellowShulkerBox current = new YellowShulkerBox(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public YellowShulkerBox(short id) {
		super(id, "YELLOW_SHULKER_BOX", (ins, f) -> {
	...
	public YellowShulkerBox(int id) {
		this((short) id);
	}

	private YellowShulkerBox(YellowShulkerBox old) {
		this(old.id);
