...
public class CobblestoneStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		CobblestoneStairs current = new CobblestoneStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("CobblestoneStairs block doesn't allow the section " + section.name());
		CobblestoneStairs current = new CobblestoneStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public CobblestoneStairs(short id) {
		super(id, "COBBLESTONE_STAIRS", (ins, f) -> {
	...
	public CobblestoneStairs(int id) {
		this((short) id);
	}

	private CobblestoneStairs(CobblestoneStairs old) {
		this(old.id);
