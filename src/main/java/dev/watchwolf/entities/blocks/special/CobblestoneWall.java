...
public class CobblestoneWall extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("CobblestoneWall block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("CobblestoneWall block doesn't contain orientation " + o.name());
		CobblestoneWall current = new CobblestoneWall(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public CobblestoneWall(short id) {
		super(id, "COBBLESTONE_WALL", (ins, f) -> {
	...
	public CobblestoneWall(int id) {
		this((short) id);
	}

	private CobblestoneWall(CobblestoneWall old) {
		this(old.id);
