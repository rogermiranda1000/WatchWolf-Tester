...
public class OxidizedCutCopperStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		OxidizedCutCopperStairs current = new OxidizedCutCopperStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("OxidizedCutCopperStairs block doesn't allow the section " + section.name());
		OxidizedCutCopperStairs current = new OxidizedCutCopperStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public OxidizedCutCopperStairs(short id) {
		super(id, "OXIDIZED_CUT_COPPER_STAIRS", (ins, f) -> {
	...
	public OxidizedCutCopperStairs(int id) {
		this((short) id);
	}

	private OxidizedCutCopperStairs(OxidizedCutCopperStairs old) {
		this(old.id);
