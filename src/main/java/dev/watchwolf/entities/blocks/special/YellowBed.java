...
public class YellowBed extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		YellowBed current = new YellowBed(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("YellowBed block doesn't allow the section " + section.name());
		YellowBed current = new YellowBed(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public YellowBed(short id) {
		super(id, "YELLOW_BED", (ins, f) -> {
	...
	public YellowBed(int id) {
		this((short) id);
	}

	private YellowBed(YellowBed old) {
		this(old.id);
