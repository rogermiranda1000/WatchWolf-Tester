...
public class SandstoneSlab extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("SandstoneSlab block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("SandstoneSlab block doesn't contain orientation " + o.name());
		SandstoneSlab current = new SandstoneSlab(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public SandstoneSlab(short id) {
		super(id, "SANDSTONE_SLAB", (ins, f) -> {
	...
	public SandstoneSlab(int id) {
		this((short) id);
	}

	private SandstoneSlab(SandstoneSlab old) {
		this(old.id);
