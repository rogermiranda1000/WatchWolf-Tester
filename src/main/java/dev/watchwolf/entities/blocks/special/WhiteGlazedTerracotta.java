...
public class WhiteGlazedTerracotta extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		WhiteGlazedTerracotta current = new WhiteGlazedTerracotta(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public WhiteGlazedTerracotta(short id) {
		super(id, "WHITE_GLAZED_TERRACOTTA", (ins, f) -> {
	...
	public WhiteGlazedTerracotta(int id) {
		this((short) id);
	}

	private WhiteGlazedTerracotta(WhiteGlazedTerracotta old) {
		this(old.id);
