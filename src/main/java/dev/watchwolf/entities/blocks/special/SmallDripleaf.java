...
public class SmallDripleaf extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		SmallDripleaf current = new SmallDripleaf(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public SmallDripleaf(short id) {
		super(id, "SMALL_DRIPLEAF", (ins, f) -> {
	...
	public SmallDripleaf(int id) {
		this((short) id);
	}

	private SmallDripleaf(SmallDripleaf old) {
		this(old.id);
