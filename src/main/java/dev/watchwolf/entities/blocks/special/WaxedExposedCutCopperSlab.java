...
public class WaxedExposedCutCopperSlab extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("WaxedExposedCutCopperSlab block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("WaxedExposedCutCopperSlab block doesn't contain orientation " + o.name());
		WaxedExposedCutCopperSlab current = new WaxedExposedCutCopperSlab(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public WaxedExposedCutCopperSlab(short id) {
		super(id, "WAXED_EXPOSED_CUT_COPPER_SLAB", (ins, f) -> {
	...
	public WaxedExposedCutCopperSlab(int id) {
		this((short) id);
	}

	private WaxedExposedCutCopperSlab(WaxedExposedCutCopperSlab old) {
		this(old.id);
