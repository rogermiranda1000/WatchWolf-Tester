...
public class DeadFireCoralWallFan extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		DeadFireCoralWallFan current = new DeadFireCoralWallFan(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public DeadFireCoralWallFan(short id) {
		super(id, "DEAD_FIRE_CORAL_WALL_FAN", (ins, f) -> {
	...
	public DeadFireCoralWallFan(int id) {
		this((short) id);
	}

	private DeadFireCoralWallFan(DeadFireCoralWallFan old) {
		this(old.id);
