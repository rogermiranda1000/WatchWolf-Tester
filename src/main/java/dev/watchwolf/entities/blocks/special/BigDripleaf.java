...
public class BigDripleaf extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		BigDripleaf current = new BigDripleaf(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public BigDripleaf(short id) {
		super(id, "BIG_DRIPLEAF", (ins, f) -> {
	...
	public BigDripleaf(int id) {
		this((short) id);
	}

	private BigDripleaf(BigDripleaf old) {
		this(old.id);
