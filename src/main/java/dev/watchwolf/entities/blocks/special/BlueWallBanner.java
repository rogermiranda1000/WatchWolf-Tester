...
public class BlueWallBanner extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		BlueWallBanner current = new BlueWallBanner(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public BlueWallBanner(short id) {
		super(id, "BLUE_WALL_BANNER", (ins, f) -> {
	...
	public BlueWallBanner(int id) {
		this((short) id);
	}

	private BlueWallBanner(BlueWallBanner old) {
		this(old.id);
