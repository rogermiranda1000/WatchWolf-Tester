...
public class WarpedStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		WarpedStairs current = new WarpedStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("WarpedStairs block doesn't allow the section " + section.name());
		WarpedStairs current = new WarpedStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public WarpedStairs(short id) {
		super(id, "WARPED_STAIRS", (ins, f) -> {
	...
	public WarpedStairs(int id) {
		this((short) id);
	}

	private WarpedStairs(WarpedStairs old) {
		this(old.id);
