...
public class BrownMushroomBlock extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		BrownMushroomBlock current = new BrownMushroomBlock(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public BrownMushroomBlock(short id) {
		super(id, "BROWN_MUSHROOM_BLOCK", (ins, f) -> {
	...
	private BrownMushroomBlock(BrownMushroomBlock old) {
		this(old.id);
