...
public class GraniteStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		GraniteStairs current = new GraniteStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("GraniteStairs block doesn't allow the section " + section.name());
		GraniteStairs current = new GraniteStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public GraniteStairs(short id) {
		super(id, "GRANITE_STAIRS", (ins, f) -> {
	...
	public GraniteStairs(int id) {
		this((short) id);
	}

	private GraniteStairs(GraniteStairs old) {
		this(old.id);
