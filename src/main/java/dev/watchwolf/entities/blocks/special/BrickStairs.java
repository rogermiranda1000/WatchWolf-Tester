...
public class BrickStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		BrickStairs current = new BrickStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("BrickStairs block doesn't allow the section " + section.name());
		BrickStairs current = new BrickStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public BrickStairs(short id) {
		super(id, "BRICK_STAIRS", (ins, f) -> {
	...
	public BrickStairs(int id) {
		this((short) id);
	}

	private BrickStairs(BrickStairs old) {
		this(old.id);
