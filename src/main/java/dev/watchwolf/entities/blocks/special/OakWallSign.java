...
public class OakWallSign extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		OakWallSign current = new OakWallSign(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public OakWallSign(short id) {
		super(id, "OAK_WALL_SIGN", (ins, f) -> {
	...
	public OakWallSign(int id) {
		this((short) id);
	}

	private OakWallSign(OakWallSign old) {
		this(old.id);
