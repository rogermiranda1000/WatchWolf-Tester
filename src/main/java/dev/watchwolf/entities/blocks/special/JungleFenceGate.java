...
public class JungleFenceGate extends Block implements Orientable, Openable, Powerable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		JungleFenceGate current = new JungleFenceGate(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public JungleFenceGate(short id) {
		super(id, "JUNGLE_FENCE_GATE", (ins, f) -> {
	...
	public JungleFenceGate(int id) {
		this((short) id);
	}

	private JungleFenceGate(JungleFenceGate old) {
		this(old.id);
