...
public class JungleDoor extends Block implements Orientable, Hinged, Openable, Powerable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		JungleDoor current = new JungleDoor(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public JungleDoor(short id) {
		super(id, "JUNGLE_DOOR", (ins, f) -> {
	...
	public JungleDoor(int id) {
		this((short) id);
	}

	private JungleDoor(JungleDoor old) {
		this(old.id);
