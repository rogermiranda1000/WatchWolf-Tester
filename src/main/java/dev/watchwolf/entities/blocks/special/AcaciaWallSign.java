...
public class AcaciaWallSign extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		AcaciaWallSign current = new AcaciaWallSign(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public AcaciaWallSign(short id) {
		super(id, "ACACIA_WALL_SIGN", (ins, f) -> {
	...
	public AcaciaWallSign(int id) {
		this((short) id);
	}

	private AcaciaWallSign(AcaciaWallSign old) {
		this(old.id);
