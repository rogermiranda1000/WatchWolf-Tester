...
public class PolishedBlackstoneBrickSlab extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("PolishedBlackstoneBrickSlab block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("PolishedBlackstoneBrickSlab block doesn't contain orientation " + o.name());
		PolishedBlackstoneBrickSlab current = new PolishedBlackstoneBrickSlab(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public PolishedBlackstoneBrickSlab(short id) {
		super(id, "POLISHED_BLACKSTONE_BRICK_SLAB", (ins, f) -> {
	...
	public PolishedBlackstoneBrickSlab(int id) {
		this((short) id);
	}

	private PolishedBlackstoneBrickSlab(PolishedBlackstoneBrickSlab old) {
		this(old.id);
