...
public class AttachedPumpkinStem extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		AttachedPumpkinStem current = new AttachedPumpkinStem(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public AttachedPumpkinStem(short id) {
		super(id, "ATTACHED_PUMPKIN_STEM", (ins, f) -> {
	...
	public AttachedPumpkinStem(int id) {
		this((short) id);
	}

	private AttachedPumpkinStem(AttachedPumpkinStem old) {
		this(old.id);
