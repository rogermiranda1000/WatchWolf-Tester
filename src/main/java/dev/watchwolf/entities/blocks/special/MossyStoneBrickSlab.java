...
public class MossyStoneBrickSlab extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("MossyStoneBrickSlab block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("MossyStoneBrickSlab block doesn't contain orientation " + o.name());
		MossyStoneBrickSlab current = new MossyStoneBrickSlab(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public MossyStoneBrickSlab(short id) {
		super(id, "MOSSY_STONE_BRICK_SLAB", (ins, f) -> {
	...
	public MossyStoneBrickSlab(int id) {
		this((short) id);
	}

	private MossyStoneBrickSlab(MossyStoneBrickSlab old) {
		this(old.id);
