...
public class MushroomStem extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		MushroomStem current = new MushroomStem(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public MushroomStem(short id) {
		super(id, "MUSHROOM_STEM", (ins, f) -> {
	...
	public MushroomStem(int id) {
		this((short) id);
	}

	private MushroomStem(MushroomStem old) {
		this(old.id);
