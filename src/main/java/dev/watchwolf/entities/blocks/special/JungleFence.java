...
public class JungleFence extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("JungleFence block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("JungleFence block doesn't contain orientation " + o.name());
		JungleFence current = new JungleFence(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public JungleFence(short id) {
		super(id, "JUNGLE_FENCE", (ins, f) -> {
	...
	public JungleFence(int id) {
		this((short) id);
	}

	private JungleFence(JungleFence old) {
		this(old.id);
