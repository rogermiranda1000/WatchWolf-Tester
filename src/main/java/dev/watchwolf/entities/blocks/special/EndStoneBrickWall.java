...
public class EndStoneBrickWall extends Block implements Orientable {
	...
	public boolean isOrientationSet(Orientable.Orientation o) throws IllegalArgumentException {
		...
		if (result == null) throw new IllegalArgumentException("EndStoneBrickWall block doesn't contain orientation " + o.name());
		return result;
	}
	@Override

	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		if (!this.orientation.containsKey(o)) throw new IllegalArgumentException("EndStoneBrickWall block doesn't contain orientation " + o.name());
		EndStoneBrickWall current = new EndStoneBrickWall(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public EndStoneBrickWall(short id) {
		super(id, "END_STONE_BRICK_WALL", (ins, f) -> {
	...
	public EndStoneBrickWall(int id) {
		this((short) id);
	}

	private EndStoneBrickWall(EndStoneBrickWall old) {
		this(old.id);
