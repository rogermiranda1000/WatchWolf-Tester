...
public class PolishedBlackstoneBrickStairs extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		PolishedBlackstoneBrickStairs current = new PolishedBlackstoneBrickStairs(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("PolishedBlackstoneBrickStairs block doesn't allow the section " + section.name());
		PolishedBlackstoneBrickStairs current = new PolishedBlackstoneBrickStairs(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public PolishedBlackstoneBrickStairs(short id) {
		super(id, "POLISHED_BLACKSTONE_BRICK_STAIRS", (ins, f) -> {
	...
	public PolishedBlackstoneBrickStairs(int id) {
		this((short) id);
	}

	private PolishedBlackstoneBrickStairs(PolishedBlackstoneBrickStairs old) {
		this(old.id);
