...
public class MagentaBed extends Block implements Orientable, Sectionable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		MagentaBed current = new MagentaBed(this);
	...
	public Sectionable setSection(Sectionable.Section section) throws IllegalArgumentException {
		if (!this.allowedSections.contains(section)) throw new IllegalArgumentException("MagentaBed block doesn't allow the section " + section.name());
		MagentaBed current = new MagentaBed(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public MagentaBed(short id) {
		super(id, "MAGENTA_BED", (ins, f) -> {
	...
	public MagentaBed(int id) {
		this((short) id);
	}

	private MagentaBed(MagentaBed old) {
		this(old.id);
