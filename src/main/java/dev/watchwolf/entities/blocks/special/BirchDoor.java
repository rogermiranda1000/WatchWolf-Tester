...
public class BirchDoor extends Block implements Orientable, Hinged, Openable, Powerable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		BirchDoor current = new BirchDoor(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public BirchDoor(short id) {
		super(id, "BIRCH_DOOR", (ins, f) -> {
	...
	public BirchDoor(int id) {
		this((short) id);
	}

	private BirchDoor(BirchDoor old) {
		this(old.id);
