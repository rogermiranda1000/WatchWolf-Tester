...
public class MagentaGlazedTerracotta extends Block implements Orientable {
	...
	public Orientable setOrientation(Orientable.Orientation o, boolean value) throws IllegalArgumentException {
		MagentaGlazedTerracotta current = new MagentaGlazedTerracotta(this);
	...
	/*   --- CONSTRUCTORS ---   */
	public MagentaGlazedTerracotta(short id) {
		super(id, "MAGENTA_GLAZED_TERRACOTTA", (ins, f) -> {
	...
	public MagentaGlazedTerracotta(int id) {
		this((short) id);
	}

	private MagentaGlazedTerracotta(MagentaGlazedTerracotta old) {
		this(old.id);
