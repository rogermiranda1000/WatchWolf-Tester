    ...
    static {
        SocketData.setReaderFunction(Block.class, (dis) -> {
            ...
            if (r.getClass().isAssignableFrom(Orientable.class)) {
                ...
                try {
                    if ((tmp & 0b100000_00) > 0) orientable.set(Orientable.Orientation.U);
                    if ((tmp & 0b010000_00) > 0) orientable.set(Orientable.Orientation.D);
                    if ((tmp & 0b001000_00) > 0) orientable.set(Orientable.Orientation.N);
                    if ((tmp & 0b000100_00) > 0) orientable.set(Orientable.Orientation.S);
                    if ((tmp & 0b000010_00) > 0) orientable.set(Orientable.Orientation.E);
                    if ((tmp & 0b000001_00) > 0) orientable.set(Orientable.Orientation.W);
